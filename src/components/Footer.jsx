        ...
        <Row className="g-4">
          <Col lg={3}>
            <Link className="me-0" href="/">
              ...
              <Image className="dark-mode-item h-40px" width={189} height={40} src={logoLight} alt="logo" />
            </Link>
            ...
            <ul className="list-inline mb-0 mt-3">
              <li className="list-inline-item"> <a className="btn btn-white btn-sm shadow px-2 text-facebook" href="#"><FaFacebookF className="fa-fw" /></a> </li>
          ...
          <Col lg={3}>
            ...
            <Row className="g-2 mt-2">
              <Col xs={6} sm={4} md={3} lg={6}>
                <span role="button"> <Image height={45} width={145} className="w-auto" src={googlePlay} alt="google-play" /> </span>
              </Col>
              <Col xs={6} sm={4} md={3} lg={6}>
                <span role="button"> <Image height={45} width={145} className="w-auto" src={playStore} alt="app-store" /> </span>
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <div className="py-3">
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body text-primary-hover"> Copyrights ©{currentYear} Eduport. Build by <Link href={developedByLink} target="_blank" className="text-body">{developedBy}</Link></div>
                  ...
                  <li className="list-inline-item">
                    <Dropdown className="dropup mt-0 text-center text-sm-end">
                      ...
                      <DropdownMenu as='ul' className="min-w-auto" aria-labelledby="languageSwitcher">
                        <li><DropdownItem className="me-4" href="#"><Image alt="uk" height={12} width={18} className="fa-fw me-2" src={ukFlag} />English</DropdownItem></li>
                        <li><DropdownItem className="me-4" href="#"><Image alt="gr" height={12} width={18} className="fa-fw me-2" src={grFlag} />German </DropdownItem></li>
                        <li><DropdownItem className="me-4" href="#"><Image alt="sp" height={12} width={18} className="fa-fw me-2" src={spFlag} />French</DropdownItem></li>
                      </DropdownMenu>
                    </Dropdown>
                  </li>
