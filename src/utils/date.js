...
export const addOrSubtractHoursFromDate = (hours, add, startingDate = new Date()) => {
  if (add) return new Date(new Date().setHours(startingDate.getHours() + hours));else return new Date(new Date().setHours(startingDate.getHours() - hours));
};
