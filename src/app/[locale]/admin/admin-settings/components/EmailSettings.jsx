...
import { editEmailTemplateData } from '../data';
import { FaEdit } from 'react-icons/fa';
import TextFormInput from '@/components/form/TextFormInput';
import ChoicesFormInput from '@/components/form/ChoicesFormInput';
import { Button, Card, CardBody, CardHeader, Col, Row } from 'react-bootstrap';
const EditEmailTemplateData = ({
  title
}) => {
  return <Col md={6} xxl={4}>
      <div className="bg-light rounded-3 d-flex justify-content-between align-items-center p-2">
        ...
        <a href="#" className="btn btn-sm btn-round btn-dark flex-shrink-0 mb-0"><FaEdit /></a>
      </div>
    </Col>;
};
const EmailSettings = () => {
        ...
        <form onSubmit={handleSubmit(() => {})}>
          ...
          <Row className="g-4 mt-4">
            <div className="d-sm-flex justify-content-between align-items-center">
              ...
              <Button variant='primary' size='sm' className="mb-0">Add Template</Button>
            </div>

            {editEmailTemplateData.map((item, idx) => <EditEmailTemplateData key={idx} {...item} />)}
