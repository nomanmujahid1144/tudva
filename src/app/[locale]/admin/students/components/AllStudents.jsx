          ...
          <Row className="g-3 align-items-center justify-content-between">
            ...
            <Col md={3}>
              <Nav className="list-inline mb-0 nav-pills nav-pill-dark-soft border-0 justify-content-end" id="pills-tab" role="tablist">
                <NavItem>
                  <NavLink eventKey={1} href="#nav-preview-tab-1" className="nav-link mb-0 me-2" data-bs-toggle="tab">
                    <FaThLarge />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink eventKey={2} href="#nav-html-tab-1" className="nav-link mb-0" data-bs-toggle="tab">
                    <FaListUl />
                  </NavLink>
                </NavItem>
              </Nav>
