...
const AllReviewsCard = ({
  ...
  return <tr>
      ...
      <td>
        <Button size='sm' variant='info-soft' className="mb-0" data-bs-toggle="modal" data-bs-target="#viewReview">View</Button>
      </td>
    </tr>;
};
const AllReviews = () => {
          ...
          <div className="table-responsive border-0">
            <Table hover className="table-dark-gray align-middle p-4 mb-0 table-hover">
              ...
              <tbody>
                ...
                {studentReviewData.slice(0, 5).map((item, idx) => <AllReviewsCard key={idx} {...item} />)}
              </tbody>
            </Table>
          </div>
        </CardBody>
