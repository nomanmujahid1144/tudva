...
const Step1 = ({
  ...
  const [quillEditorContent, setQuillEditorContent] = useState(`
   <div className="bg-body border rounded-bottom h-400px overflow-hidden" id="quilleditor">
      ...
      `);
  return <form id="step-1" onSubmit={goToNextStep} role="tabpanel" className="content fade" aria-labelledby="steppertrigger1">
      ...
      <Row className="g-4">
        ...
        <Col md={6}>
          ...
          <ChoicesFormInput className="form-select js-choice border-0 z-index-9 bg-transparent" aria-label=".form-select-sm" data-search-enabled="false" data-remove-item-button="true">
        ...
        <Col md={6}>
          ...
          <ChoicesFormInput className="form-select js-choice border-0 z-index-9 bg-transparent" aria-label=".form-select-sm" data-max-item-count={3} data-remove-item-button="true">
        ...
        <Col xs={12}>
          ...
          height: 400
        }} value={quillEditorContent} onChange={setQuillEditorContent} id="quilltoolbar" />
        </Col>
