...
const Step2 = ({
  ...
  return <form id="step-2" onSubmit={goToNextStep} role="tabpanel" className="content fade" aria-labelledby="steppertrigger2">
      <h4>Course media</h4>
      <hr />
      <Row>
        <Col xs={12}>
          <div className="text-center justify-content-center align-items-center p-4 p-sm-5 border border-2 border-dashed position-relative rounded-3">
            <Image src={galleryImg} className="h-50px" alt='gallery' />
            <div>
        ...
        <Col xs={12}>
          ...
          <div className="position-relative">
            <Image src={about4Img} className="rounded-4" alt={'about4Img'} />
