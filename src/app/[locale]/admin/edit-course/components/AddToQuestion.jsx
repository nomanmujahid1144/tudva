...
const AddToQuestion = () => {
  ...
  return <>
      <Button variant='primary-soft' size='sm' onClick={toggle} className="mb-0" data-bs-toggle="modal" data-bs-target="#addQuestion"><BsPlusCircle className="me-2" />Add Question</Button>
