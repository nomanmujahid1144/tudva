...
const CounterCard = ({
  ...
  return <Card className={`card-body bg-${variant} bg-opacity-15 p-4 h-100`}>
      <div className="d-flex justify-content-between align-items-center">
        <div>
          <h2 className="purecounter mb-0 fw-bold" data-purecounter-start={0} data-purecounter-end={1958} data-purecounter-delay={200}><CountUp end={count} suffix={suffix} delay={1} /></h2>
...
const Counter = () => {
  return <Row className="g-4 mb-4">
      {adminCounterData.map((item, idx) => <Col md={6} xxl={3} key={idx}>
            <CounterCard {...item} />
          </Col>)}
    </Row>;
};
