...
const NoticeBoardCard = ({
  ...
  return <div className="d-flex justify-content-between position-relative">
      <div className="d-sm-flex">
        ...
        <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
          <h6 className="mb-0"><a href="#" className="stretched-link">{title}</a></h6>
        ...
        <CardFooter className="border-top">
          <div className="alert alert-success d-flex align-items-center mb-0 py-2">
            ...
            <div className="ms-auto">
              <Button size='sm' variant='success-soft' className="mb-0" href="#!"> View all </Button>
            </div>
          </div>
        </CardFooter>
      </Card>
