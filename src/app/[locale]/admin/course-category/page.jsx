      ...
      <div>
        <Row className="mb-3">
          <Col xs={12} className="d-sm-flex justify-content-between align-items-center">
            ...
            <Link href="/instructor/create-course" className="btn btn-sm btn-primary mb-0">Create a Course</Link>
          </Col>
        </Row>
          ...
          <CardBody>
            <div className="table-responsive border-0 rounded-3">
              <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                ...
                <tbody>
                  {coursesData.slice(0, 7).map((item, idx) => <CourseCategoryCard key={idx} {...item} />)}
                </tbody>
              </table>
            </div>
          </CardBody>
