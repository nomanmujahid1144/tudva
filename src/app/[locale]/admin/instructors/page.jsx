      ...
      <Card className="bg-transparent border h-100">
        <CardHeader className="bg-transparent border-bottom d-flex align-items-sm-center justify-content-between">
          <div className="d-sm-flex align-items-center">
            ...
            <div className="ms-0 ms-sm-2 mt-2 mt-sm-0">
              <h5 className="mb-0"><a href="#">{name}</a></h5>
        ...
        <CardBody>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div className="d-flex align-items-center">
              <div className="icon-md bg-orange bg-opacity-10 text-orange rounded-circle flex-shrink-0"><FaUserGraduate /></div>
        ...
        <CardFooter className="bg-transparent border-top">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <Link href="#" className="btn btn-link text-body p-0 mb-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Message" aria-label="Message">
              <BsEnvelopeFill />
            </Link>
          </div>
        </CardFooter>
          ...
          <div className="tab-content">
            <div className="tab-pane fade show active" id="nav-preview-tab-1">
              <Row className=" g-4">
                ...
                {coursesData.slice(0, 8).map((item, idx) => <InstructorsCard key={idx} {...item} />)}
              </Row>
            </div>
          </div>
        </CardBody>
