...
const InstructorRequestsCard = ({
  ...
  return <tr>
      ...
      {action === 'accept' ? <td>
            <Button variant='success' className=" me-1 mb-1 mb-md-0 disabled">Accepted</Button>
            <Button variant='primary-soft' className="me-1 mb-0" data-bs-toggle="modal" data-bs-target="#appDetail">View App</Button>
          </td> : action === 'pending' ? <td>
              <Button variant='success-soft' className=" me-1 mb-1 mb-lg-0">Accept</Button>
              <Button variant='secondary-soft' className=" me-1 mb-1 mb-lg-0">Reject</Button>
              <Button variant='primary-soft' className=" me-1 mb-0" data-bs-toggle="modal" data-bs-target="#appDetail">View App</Button>
            </td> : <td>
              <Button variant='secondary' className=" me-1 mb-1 mb-md-0 disabled">Rejected</Button>
              <Button variant='primary-soft' className=" me-1 mb-0" data-bs-toggle="modal" data-bs-target="#appDetail">View App</Button>
            </td>}
    </tr>;
};
        ...
        <CardBody>
          <div className="table-responsive border-0">
            <Table className="table-dark-gray align-middle p-4 mb-0 table-hover">
              ...
              <tbody>
                {coursesData.slice(0, 7).map((item, idx) => <InstructorRequestsCard key={idx} {...item} />)}
              </tbody>
            </Table>
          </div>
        </CardBody>
