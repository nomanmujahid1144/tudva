  ...
  return <section className="bg-light position-relative">
      ...
      <Container className="position-relative">
        <Row className="justify-content-between align-items-center my-5">
          ...
          <Col lg={5} className="position-relative mt-4 mt-lg-0">
            <Image src={about4} className="border border-5 border-white rounded-2" alt="about" />
            <div className="position-absolute top-50 start-50 translate-middle">
              <GlightBox href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn text-danger btn-round btn-white-shadow btn-lg mb-0" data-glightbox data-gallery="video-tour">
                <FaPlay />
              </GlightBox>
            </div>
          </Col>
