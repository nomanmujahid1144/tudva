            ...
            <Row className="mt-5">
              <Col sm={6} lg={12} xl={6} className="mb-5">
                <Card className="card-body shadow">
                  ...
                  <h6>Email</h6>
                  <p className="h6 mb-0"><a href="#" className="text-primary-hover fw-light stretched-link">example@gmail.com</a></p>
                </Card>
              </Col>
              <Col sm={6} lg={12} xl={6} className="mb-5">
                <Card className="card-body shadow">
                  ...
                  <p className="h6 mb-0"><a href="#" className="text-primary-hover fw-light stretched-link">+256 359 556</a></p>
                </Card>
              </Col>
              <Col sm={6} lg={12} xl={6} className="mb-5 mb-xl-0">
                <Card className="card-body shadow">
                  ...
                  <h6>Telephone</h6>
                  <p className="h6 mb-0"><a href="#" className="text-primary-hover fw-light stretched-link">+123 456 789</a></p>
                </Card>
              </Col>
              <Col sm={6} lg={12} xl={6} className="mb-5 mb-xl-0">
                <Card className="card-body shadow">
                  ...
                  <h6>Website</h6>
                  <p className="h6 mb-0"><a href="#" className="text-primary-hover fw-light stretched-link">http://example.com</a></p>
                </Card>
              </Col>
            </Row>
          </Col>
          <Col lg={6}>
            <Card className="card-body shadow p-4 p-sm-5 position-relative">
              ...
              <form className="row g-3 position-relative" onSubmit={handleSubmit(() => {})}>
                ...
                <Col xs={12}>
                  <Button variant="primary" type="submit" className="mb-0">Send message</Button>
                </Col>
              </form>
            </Card>
          </Col>
