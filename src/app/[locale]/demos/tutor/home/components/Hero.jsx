      ...
      <Container>
        <Row className="align-items-center justify-content-between">
          <Col lg={6} className="position-relative z-index-9">
            <h6 className="mb-3 font-base"><BsPinMapFill className="me-2" />St Joseph, Eugene, Oregon, USA</h6>
            <h1 className="display-4">Academia tuition classes</h1>
            <p className="lead mb-4">We are so eager to be working with kids and making a difference in their careers. Being a mentor is what we have always wanted to be.</p>
            <Row className="my-3">
              <HeroSlider />
            </Row>
            <a href="#contact-form" className="btn btn-primary">Contact me!</a>
          </Col>
          <Col lg={6} className="position-relative mt-5 mt-lg-0">
            ...
            <div className="position-absolute top-0 start-50 translate-middle-x ms-n7 mt-n4 me-n3 z-index-9 d-none d-sm-block">
              <div className="px-4 py-3 bg-white bg-opacity-10 bg-blur border border-light shadow-lg rounded-4">
                ...
                <ul className="list-inline mb-0">
                  <li className="list-inline-item"> <Link className="btn btn-round btn-sm bg-facebook" href=""><FaFacebookF className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn btn-round btn-sm bg-instagram-gradient" href=""><FaInstagram className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn btn-round btn-sm bg-twitter" href=""><FaTwitter className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn btn-round btn-sm bg-linkedin" href=""><FaLinkedinIn className="fa-fw" /></Link> </li>
                </ul>
              </div>
            </div>
            <div className="position-absolute bottom-0 start-0 mb-0 mb-sm-4 ms-3 ms-sm-5 z-index-9">
              <div className="d-flex align-items-center p-2 p-sm-3 bg-white shadow rounded-4">
                <div className="icon-lg bg-white rounded-circle shadow">
                  <Image src={element17} className="h-30px" alt="" />
                </div>
                <div className="ms-2">
            ...
            <Image src={about7} className="rounded-3 z-index-1 position-relative" alt="Tutor image" />
          </Col>
        </Row>
      </Container>
    </section>;
