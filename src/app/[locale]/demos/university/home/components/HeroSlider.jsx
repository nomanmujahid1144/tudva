          ...
          <Col xs={12}>
            <div className="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
              <TinySlider settings={courseSliderSettings} className="tiny-slider-inner">
                ...
                backgroundImage: `url(${backgroundImg1.src})`,
                    ...
                    <div className="w-100 my-auto">
                      <Row className="justify-content-center">
                        <Col xs={11} lg={7}>
                          ...
                          <p className="text-white">This Bootstrap 5 based theme is ideal for all types of sites that offer education such as Kindergarten, School, College, University, Courses Hub, Training Center, or any Academy.</p>
                          <Link href="/university/admission/form" className="btn btn-primary me-2 mb-0">Admissions</Link>
                          <a href="#" className="btn btn-outline-white mb-0">Learn More</a>
                        </Col>
                      </Row>
                    </div>
                  </div>
                ...
                backgroundSize: 'cover'
                  ...
                  <div className="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                    <div className="w-100 my-auto">
                      <Row className="justify-content-center">
                        <Col xs={11} lg={6}>
                          <Image className="rounded-1 h-70px" src={universityLogo} alt="university logo" />
                          <h1 className="mb-0 text-white display-6">Get new skills <br /> for the&nbsp;
                            <span className="position-relative">digital world
                              <span className="position-absolute top-50 start-50 translate-middle ms-4 z-index-n1">
                                <svg width="366px" height="62.1px" enableBackground="new 0 0 366 62.1" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className="text-white">Get the right professional certificate program for you. See what course other students and experts in your domain are learning on</p>
                          <a href="#" className="btn btn-white mb-0">Get Started</a>
                        </Col>
                      </Row>
                    </div>
                  </div>
