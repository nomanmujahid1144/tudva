...
const CourseVideoCard = ({
  ...
  return <Card className={clsx("p-2 shadow", {
    "pb-0": showPricing
  })}>
      <div className={clsx("overflow-hidden h-xl-200px", {
      ...
      {showPricing && <CardBody>
          <Row className="g-3">
            {pricingPlans.map((plan, idx) => <Col sm={4} lg={6} xl={4} key={idx}>
                <div className="d-flex align-items-center">
                  <a href="#" className="btn btn-orange rounded-2 me-3 mb-0"><BsCart3 className="fs-5" /></a>
                  <div>
                    <span className="badge text-bg-info mb-1">{plan.duration} months</span>
                    <h5 className="mb-0">{currency}{plan.price}</h5>
                  </div>
                </div>
              </Col>)}
          </Row>
      ...
      <Col xs={12}>
        <Row className="justify-content-between">
          <TabContainer defaultActiveKey='1'>
            <Col lg={6}>
              <h3>Art &amp; Design</h3>
              <p className="mb-3">Perceived end knowledge certainly day sweetness why cordially. Ask a quick six seven offer see among. Handsome met debating sir dwelling age material. As style lived he worse dried. Offered related so visitors we private removed.</p>
              <Nav as="ul" className="nav-pills nav-pill-dark-soft mb-0" id="course-pills-tab-inner" role="tablist">
                <NavItem className="me-2 me-sm-3" role="presentation">
                  <NavLink as='button' eventKey='1'>Art &amp; Design</NavLink>
                </NavItem>
                <NavItem className="me-2 me-sm-3" role="presentation">
                  <NavLink as='button' eventKey='2'>Graphic Design</NavLink>
                </NavItem>
                <NavItem className="me-2 me-sm-3" role="presentation">
                  <NavLink as='button' eventKey='3'>Web Design</NavLink>
                </NavItem>
              </Nav>
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  <ul className="list-inline mb-0">
                    {Array(Math.floor(4.5)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaStar size={14} className="text-warning" /></li>)}
                    {!Number.isInteger(4.5) && <li className="list-inline-item me-1 small"> <FaStarHalfAlt size={14} className="text-warning" /> </li>}
                    {4.5 < 5 && Array(5 - Math.ceil(4.5)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaRegStar size={14} className="text-warning" /></li>)}
                  </ul>
                ...
                <TabPane eventKey="3" className="fade" id="course-pills-tab03" role="tabpanel" aria-labelledby="course-pills-tab-03">
                  <Card className="p-2 shadow">
                    <div className="overflow-hidden h-xl-200px">
                      <Image src={about14} className="card-img-top" alt="course image" />
                      <div className="card-img-overlay d-flex p-3">
                        <div className="m-auto">
                          <GlightBox href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox data-gallery="course-video">
                            <FaPlay />
                    ...
                    <CardBody className="px-2">
                      <p className="mb-0"><span className="h6 mb-0 fw-bold me-1">Note:</span>Before you learning this video you need to first learn Beginner course</p>
                    </CardBody>
                  </Card>
                </TabPane>
              </TabContent>
...
const Development = () => {
  const features = ["Create responsive, accessible, and beautiful layouts", "Course Videos & Readings", "Manipulate the DOM with vanilla JS", "Master the command line interface", "Create your own Node modules"];
  return <Row className="row">
      <Col lg={6}>
        <h3>Development</h3>
        <p className="mb-3">Ask a quick six seven offer see among. Handsome met debating sir dwelling age material. As style lived he worse dried. Offered related so visitors we private removed.</p>
        <h6 className="mt-4">What you’ll learn</h6>
        <ul className="list-group list-group-borderless mb-3">
          {features.map((feature, idx) => <li className="list-group-item h6 fw-light d-flex mb-0" key={idx}><BsPatchCheckFill className="text-success me-2" />{feature}</li>)}
        </ul>
      </Col>
      <Col lg={6}>
...
const PopularCourse = ({
  ...
  return <Row className="g-4">
      <Col lg={6}>
        <h3>{title}</h3>
        <p className="mb-3">Handsome met debating sir dwelling age material. As style lived he worse dried. Offered related so visitors we private removed.</p>
        <div className="d-flex align-items-center mb-3">
          <h2 className="me-3 mb-0">4.0</h2>
          <div>
            <ul className="list-inline mb-0">
              {Array(Math.floor(4)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaStar size={14} className="text-warning" /></li>)}
              {!Number.isInteger(4) && <li className="list-inline-item me-1 small"> <FaStarHalfAlt size={14} className="text-warning" /> </li>}
              {4 < 5 && Array(5 - Math.ceil(4)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaRegStar size={14} className="text-warning" /></li>)}
            </ul>
            <p className="mb-0">Review from our students	</p>
          </div>
        </div>
        <div className="mt-3">
          <Button variant="success" className="me-1">Free trial</Button>
...
const PopularCourses = () => {
  return <section className="bg-light position-relative overflow-hidden">
        ...
        <Row className="mb-4">
          <Col xs={12}>
            <h2 className="fs-1 fw-bold">
              ...
              <span className="position-relative z-index-1">Courses
        ...
        <TabContainer defaultActiveKey='design'>
          <Nav as='ul' className="nav-pills nav-pill-soft mb-3" id="course-pills-tab" role="tablist">
            <NavItem className="me-2 me-sm-5" role="presentation">
              <NavLink eventKey='design' as='button'>Art &amp; Design</NavLink>
            </NavItem>
            <NavItem className="me-2 me-sm-5" role="presentation">
              <NavLink eventKey='development' as='button'>Development</NavLink>
            </NavItem>
            <NavItem className="me-2 me-sm-5" role="presentation">
              <NavLink eventKey='data-science' as='button'>Data Science</NavLink>
            </NavItem>
            <NavItem className="me-2 me-sm-5" role="presentation">
              <NavLink eventKey='marketing' as='button'>Marketing</NavLink>
            </NavItem>
            <NavItem className="me-2 me-sm-5" role="presentation">
              <NavLink eventKey='finance' as='button'>Finance</NavLink>
            </NavItem>
          </Nav>
