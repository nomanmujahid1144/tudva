...
const UserProgressCard = () => {
  return <Card className="p-2 bg-transparent border">
      <Row className="g-0">
        <Col md={3}>
          <Image src={course1} className="rounded-2" alt="Card image" />
        </Col>
        <Col md={9}>
          <CardBody>
            <div className="d-flex justify-content-between">
              <div>
                <a href="#" className="badge text-bg-primary me-1">Marketing</a>
                <a href="#" className="badge text-bg-dark">Beginner</a>
              </div>
              <Dropdown drop="start" className="flex-shrink-0">
                <DropdownToggle as='a' className="text-primary-hover text-secondary p-0 mb-0" id="cardShareAction2" data-bs-toggle="dropdown" aria-expanded="false">
                  <BsThreeDotsVertical />
                </DropdownToggle>
                <DropdownMenu className="dropdown-menu-end min-w-auto" aria-labelledby="cardShareAction2">
                  <li><DropdownItem href="#">Upgrade Course</DropdownItem></li>
                  <li><DropdownItem href="#">Rate Course</DropdownItem></li>
                  <li><DropdownItem href="#">Share course</DropdownItem></li>
                  <li><DropdownItem href="#">Unroll</DropdownItem></li>
                </DropdownMenu>
              </Dropdown>
            </div>
            <CardTitle className="mt-3 mb-0"><a href="#">The Complete Digital Marketing Course - 12 Courses in 1</a></CardTitle>
            ...
            <div className="d-flex justify-content-between align-items-center mt-3">
              ...
              <Button variant="primary-soft" size="sm" className="mb-0">Continue</Button>
            </div>
          </CardBody>
        </Col>
      </Row>
...
const ExamScheduleCard = () => {
  return <Card className="card-body bg-transparent border">
      ...
      <div className="d-flex align-items-center position-relative">
        ...
        <div className="ms-3">
          <a href="#" className="d-inline-block text-truncate mb-0 h6 fw-normal stretched-link">Quiz - Digital Marketing</a>
          <ul className="nav nav-divider small mb-0">
