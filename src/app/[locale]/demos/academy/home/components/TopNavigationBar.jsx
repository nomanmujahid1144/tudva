...
import { Card, CardBody, CardFooter, CardHeader, Col, Collapse, Container, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, NavItem } from "react-bootstrap";
...
const TopNavigationBar = () => {
  ...
  return <>
      <header className={clsx("navbar-light navbar-sticky", {
            ...
            <Collapse in={isOpen} className="navbar-collapse">
              <div>
                ...
                <ul className="navbar-nav navbar-nav-scroll ms-auto">
                  <NavItem><a className="nav-link" href="#">For Enterprise</a></NavItem>
                  <NavItem><a className="nav-link" href="#">Eduport Business</a></NavItem>
                  <NavItem><a className="nav-link" href="#">My learning</a></NavItem>
                </ul>
              </div>
            </Collapse>
              ...
              <div>
                <ul className="navbar-nav navbar-nav-scroll mx-auto">
                  <Dropdown className="nav-item" role="button">
                    <DropdownToggle as='a' className="nav-link arrow-none active">Development<FaChevronDown className="ms-1" size={10} /> </DropdownToggle>
                    <ul className="dropdown-menu" aria-labelledby="demoMenu">
                      <li> <DropdownItem href="#">Web Development</DropdownItem> </li>
                      <li> <DropdownItem href="#">Data Science</DropdownItem> </li>
                      <li> <DropdownItem href="#">Mobile Development</DropdownItem> </li>
                      <li> <DropdownItem href="#">Programing Language</DropdownItem> </li>
                      <li> <DropdownItem href="#">Software Testing</DropdownItem> </li>
                      <li> <DropdownItem href="#">Software Engineering</DropdownItem> </li>
                      <li> <DropdownItem href="#">Software Development Tools</DropdownItem> </li>
                    </ul>
                  </Dropdown>
                  <NavItem><a className="nav-link" href="#">Finance &amp; Accounting</a></NavItem>
                  <NavItem><a className="nav-link" href="#">Personal Development</a></NavItem>
                  <NavItem><a className="nav-link" href="#">IT &amp; Software</a></NavItem>
                  <NavItem><a className="nav-link" href="#">Personal Development</a></NavItem>
                </ul>
              </div>
            </Collapse>
