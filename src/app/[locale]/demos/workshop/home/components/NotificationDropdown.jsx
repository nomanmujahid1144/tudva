...
const NotificationDropdown = () => {
  return <Dropdown drop="start" className="nav-item ms-0 ms-md-3">
        ...
        <Card className="bg-transparent">
          ...
          <CardBody className="p-0">
            <ul className="list-group list-unstyled list-group-flush">
              {notificationsData.map((notification, idx) => <li key={idx}>
                  <Link href="" className="list-group-item-action border-0 border-bottom d-flex p-3">
                    <div className="me-3">
                      <div className="avatar avatar-md">
                        <Image className="avatar-img rounded-circle" src={notification.avatar} alt="avatar" />
                      </div>
                    </div>
                    <div>
