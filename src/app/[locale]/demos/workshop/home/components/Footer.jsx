        ...
        <Row>
          <Col xs={12}>
            <div className="d-md-flex justify-content-between align-items-center pt-2 pb-4 text-center">
              <div className="text-primary-hover"> Copyrights ©{currentYear} Eduport. Build by <Link href={developedByLink} target="_blank" className="text-reset">{developedBy}</Link>.</div>
