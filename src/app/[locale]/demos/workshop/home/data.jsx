...
export const notificationsData = [{
  title: "Congratulate Joan Wallace",
  ...
  title: "Update v2.3 completed",
  description: "What's new! Find out about new features",
  avatar: avatar3
}];
export const features = [{
  title: "Occasional Video Update",
  description: "Mountains in just switching city steps Might rung line what Was or between towards the have phase.",
  icon: <svg className="fill-primary" width="63.28px" height="47.41px" viewBox="0 0 63.28 47.41">
  ...
  description: "Prisoners And mountains in just switching city steps Might rung line Was or between the have phase.",
  icon: <svg className="fill-orange" width="54.22px" height="58.19px" viewBox="0 0 54.22 58.19">
  ...
  description: "Switching city steps Might rung line what Mr Bulk; Was or between towards the have phase.",
  icon: <svg className="fill-purple" width="54.22px" height="52.86px" viewBox="0 0 54.22 52.86">
  ...
  description: "Go he prisoners And mountains in just switching city steps Might.",
  icon: <svg className="fill-warning" width="60.77px" height="52.15px" viewBox="0 0 60.77 52.15">
  ...
  description: "Go he prisoners And mountains in just switching city steps Might.",
  icon: <svg className="fill-success" width="55.44px" height="52.15px" viewBox="0 0 55.44 52.15">
...
export const faqsData = [{
  ...
  answer: "First am plate jokes to began to cause a scale. Subjects he prospect elegance followed no overcame possible it on. Improved own provided blessing may peculiar domestic. Sight house has sex never. No visited raising gravity outward subject my cottage Mr be."
}, {
