      ...
      <Container>
        <Row className="mb-3 mb-sm-4">
          <Col xs={12} className="mx-auto text-center">
            <h2 className="fs-1 fw-bold">
              ...
              <span className="position-relative z-index-1">Moments
        ...
        <Row className="g-4">
          <Col lg={4}>
            <Row className="g-4">
              <Col md={6}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event11} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event11.src}>
              ...
              <Col md={6}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event12} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event12.src}>
                    <BsFullscreen size={30} className="fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-3 p-2 lh-1" />
                  </GlightBox>
                </Card>
              </Col>
              <Col xs={12}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event14} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event14.src}>
                    <BsFullscreen size={30} className="fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-3 p-2 lh-1" />
                  </GlightBox>
                </Card>
              </Col>
          ...
          <Col lg={4}>
            <Card className="overflow-hidden">
              <div className="card-overlay-hover">
                <Image src={event17} className="rounded-3" alt="course image" />
              </div>
              <a className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event17.src}>
                <BsFullscreen size={30} className="fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-3 p-2 lh-1" />
              </a>
            </Card>
          </Col>
          <Col lg={4}>
            <Row className="g-4">
              <Col xs={12}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event16} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href="https://www.youtube.com/embed/tXHviS-4ygo">
              ...
              <Col md={6}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event13} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event13.src}>
                    <BsFullscreen size={30} className="fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-3 p-2 lh-1" />
                  </GlightBox>
                </Card>
              </Col>
              <Col md={6}>
                <Card className="overflow-hidden">
                  <div className="card-overlay-hover">
                    <Image src={event15} className="rounded-3" alt="course image" />
                  </div>
                  <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={event15.src}>
                    <BsFullscreen size={30} className="fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-3 p-2 lh-1" />
                  </GlightBox>
                </Card>
              </Col>
