  ...
  return <section className="position-relative">
      ...
      <Container className="position-relative mt-0 mt-sm-5 pt-5">
        <Row className="align-items-center">
          <Col md={5}>
            <h1 className="mb-3">We will help you Grow your Knowledge and Skills</h1>
            <h6 className="mb-3">1000+ professional Courses for Your Career</h6>
            <Button variant='primary'>Get Started</Button>
          </Col>
          <Col md={7}>
            <Image src={element5} alt="element-image" />
          </Col>
        </Row>
      </Container>
    </section>;
