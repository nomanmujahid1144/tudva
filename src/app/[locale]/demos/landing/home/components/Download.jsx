          ...
          <Col md={5} className="position-relative z-index-9">
            ...
            <Row>
              <Col xs={6} sm={4} md={6} lg={4}>
                <span role="button"><Image src={googlePlay} className="btn-transition w-auto" alt="google-play" /></span>
              </Col>
              <Col xs={6} sm={4} md={6} lg={4}>
                <span role="button"><Image src={appStore} className="btn-transition w-auto" alt="app-store" /></span>
              </Col>
            </Row>
          </Col>
