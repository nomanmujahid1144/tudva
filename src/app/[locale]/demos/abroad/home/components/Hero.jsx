...
const Hero = () => {
  return <section className="position-relative pb-0 pb-md-5 overflow-hidden">
      <figure className="position-absolute  top-50 end-0 translate-middle-y me-n8 d-none d-sm-block">
        <svg className="fill-success opacity-1" width="634.1px" height="776px">
    ...
    C650.5,419.6,675-127.8,306.2,27.3C234,57.5,178.4,124.5,161.4,200.8z" />
      ...
      <figure className="position-absolute top-50 end-0 translate-middle-y me-n4 mt-n8 d-none d-lg-block">
        <svg className="fill-dark" width="349px" height="188.4px">
      ...
      <Container>
        <Row>
          <Col lg={8} className="mb-2 mb-lg-4 position-relative">
            <figure className="position-absolute top-0 start-0 translate-middle ms-n5 d-none d-md-block">
              <svg className="fill-orange" width="114px" height="140px" viewBox="0 0 114 140">
            ...
            <h1 className="display-4 mb-3 mb-lg-0">Best platform for study in Abroad.</h1>
          </Col>
          <Col lg={5} className="mb-4 mb-lg-0">
            <p className="mb-4">Contrasted by oh estimating instrument. Size like body someone had. Are conduct viewing boy minutes</p>
            <a href="#" className="btn btn-lg btn-primary-soft mb-4">Get Inquiry</a>
            <Row className="g-4">
              {counterData.map((item, idx) => {
              const Icon = item.icon;
              return <Col md={6} key={idx}>
                    <div className="d-flex align-items-center">
                      <div className={`icon-lg fs-4 text-${item.variant} bg-${item.variant} bg-opacity-10 rounded flex-shrink-0`}> {Icon && <Icon />} </div>
                      <div className="ms-3">
                        <div className="d-flex">
                          <h4 className="purecounter fw-bold mb-0">
                            <CountUp end={item.count} suffix={item.suffix} delay={1} />
                          </h4>
                        </div>
                        <div>{item.title}</div>
                      </div>
          ...
          <Col lg={7}>
            <div className="position-relative">
              <figure className="position-absolute bottom-0 start-0 z-index-9 mb-n5 ms-n6 d-none d-xl-block">
              ...
              <Image src={backgroundImg4} className="rounded-3" alt="bg-image" />
            </div>
          </Col>
        </Row>
      </Container>
