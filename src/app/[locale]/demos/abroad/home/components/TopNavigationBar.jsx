              ...
              <div>
                <ul className="navbar-nav navbar-nav-scroll">
                  <Dropdown as='li' className="nav-item">
                    <DropdownToggle as='a' className="arrow-none nav-link d-flex align-items-center justify-content-between ps-0">Category<FaChevronDown className="ms-1" size={10} /> </DropdownToggle>
                    <ul className="dropdown-menu" aria-labelledby="demoMenu">
                      <li> <DropdownItem href="#">IELTS</DropdownItem></li>
                      <li> <DropdownItem href="#">GRE</DropdownItem></li>
                      <li> <DropdownItem href="#">Duolingo</DropdownItem></li>
                      <li> <DropdownItem href="#">Toefl</DropdownItem></li>
                    </ul>
                  </Dropdown>
                  <NavItem as={'li'}><a className="nav-link" href="#">Eduport business</a></NavItem>
                  <NavItem as={'li'}><a className="nav-link" href="#">My learning</a></NavItem>
                  <NavItem as={'li'}><a className="nav-link" href="#">Contact</a></NavItem>
                </ul>
              </div>
            </Collapse>
          </Col>
          ...
          <Col xs={3} md={4} xl={5} className="d-flex justify-content-end pe-0">
            <ul className="nav flex-row align-items-center list-unstyled ms-xl-auto">
              <Dropdown className="nav-item ms-2 position-relative overflow-visible">
                ...
                <span className="position-absolute top-0 start-100 translate-middle badge rounded-circle text-bg-success mt-2 mt-xl-3 ms-n3 smaller">5
                  ...
                  <Card className="bg-transparent">
                    ...
                    <CardBody className="p-0">
                      <Row className="p-3 g-2">
                        <Col xs={3}>
                          <Image className="rounded-2" src={book2} alt="avatar" />
                        </Col>
                        <Col xs={9}>
                          <div className="d-flex justify-content-between">
                            <h6 className="m-0">Angular 4 Tutorial in audio (Compact Disk)</h6>
                            <a href="#" className="small text-primary-hover"><BsXLg /></a>
                          </div>
                          <form className="choices-sm pt-2 col-4">
                            <ChoicesFormInput options={{
                            searchEnabled: false
                          }} className="form-select js-choice border-0 bg-transparent" data-search-enabled="false">
                              <option>1</option>
                    ...
                    <CardFooter className="bg-transparent border-top py-3 text-center d-flex justify-content-between position-relative">
                      <Button variant="light" size="sm" className="mb-0">View Cart</Button>
                      <Button variant="success" size="sm" className="mb-0">Checkout</Button>
                    </CardFooter>
                  </Card>
                </DropdownMenu>
              </Dropdown>
              <Dropdown className="nav-item nav-search d-none d-sm-block">
                <DropdownToggle as='a' className="arrow-none nav-link mb-0" role="button" id="navSearch" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-display="static">
                ...
                <DropdownMenu className="dropdown-menu-end shadow rounded p-2" aria-labelledby="navSearch">
                  ...
                  <ul className="list-group list-group-borderless p-2 small">
                    ...
                    <li className="list-group-item text-primary-hover text-truncate">
                      <Link href="#" className="text-body"> <FaClock className="me-1" />Digital marketing course for Beginner</Link>
                    </li>
                  </ul>
                </DropdownMenu>
              </Dropdown>
              <li className="nav-item ms-2 d-none d-md-block">
                <Button variant="dark" size="sm" className="mb-0">Sign In</Button>
              </li>
            </ul>
          </Col>
        </Row>
