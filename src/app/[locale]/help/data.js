...
export const topicData = [{
  icon: BsEmojiSmile,
  title: 'Get started',
  features: ['Gulp and Customization', 'Color Scheme and Logo Settings', 'Dark mode, RTL Version and Lazy Load', 'Sources, Credits and Changelog', 'Updates and Support'],
  variant: 'success'
}, {
  icon: BsLayers,
  title: 'Account Setup',
  features: ['Connecting to your Account', 'Edit your profile information', 'Connecting to other Social Media Accounts', 'Adding your profile picture', 'Describing your store'],
  variant: 'warning'
}, {
  icon: BsInfoCircle,
  title: 'Other Topics',
