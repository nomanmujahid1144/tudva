              ...
              <form className="mt-4">
                ...
                <div className="bg-body border rounded-2 p-2">
                  <div className="input-group">
                    ...
                    <button type="button" className="btn btn-blue mb-0 rounded-2">Notify Me!</button>
                  </div>
                </div>
              </form>
            </Col>
            <Col lg={7} className="text-center">
              <Image src={comingSoonImg} className="h-300px h-sm-400px h-md-500px h-xl-700px" height={700} alt='coming Soon' />
            </Col>
          </Row>
        </Container>
      </section>
