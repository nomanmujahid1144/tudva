...
const StudentsCard = ({
  ...
  return <Card className="card-body h-100">
        ...
        <div className="bg-light p-4 rounded-3">
          ...
          <Row>
            <div className="tiny-slider arrow-round arrow-blur arrow-hover">
              <TinySlider settings={courseSliderSettings} className="pb-1" data-autoplay="true" data-arrow="true" data-edge={2} data-dots="false" data-items={3} data-items-lg={2} data-items-sm={1}>
                {allReviews?.map((item, idx) => <div key={idx}>
                      <StudentsCard {...item} />
                    </div>)}
              </TinySlider>
            </div>
