  ...
  return <section>
      <Container>
        <Row className="g-lg-5 align-items-lg-center">
          <Col md={4}>
            <Image src={instructorImg} className="rounded-2" alt="..." />
          </Col>
          <Col md={8}>
            ...
            <ul className="list-inline hstack flex-wrap gap-3 mb-0">
              <li className="list-inline-item"> <h5 className="mb-0">Follow me on:</h5> </li>
              <li className="list-inline-item"> <a className="text-facebook" href="#"><FaFacebookSquare /> Facebook</a> </li>
              <li className="list-inline-item"> <a className="text-danger" href="#"><FaSquareInstagram /> Instagram</a> </li>
              <li className="list-inline-item"> <a className="text-twitter" href="#"><FaTwitterSquare /> Twitter</a> </li>
              <li className="list-inline-item"> <a className="text-youtube" href="#"><FaYoutubeSquare /> Youtube</a> </li>
            </ul>
          </Col>
        </Row>
      </Container>
