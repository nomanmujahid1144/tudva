...
const InstructorCard = ({
  ...
  return <Card className="shadow p-2">
      <Row className="g-0">
        <Col ms={4}>
          <Image src={image} className="rounded-3" alt="..." />
        </Col>
        <Col md={8}>
          <CardBody>
            <div className="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
              <div>
                <CardTitle className="mb-0"><a href="#">{name}</a></CardTitle>
                <p className="small mb-2 mb-sm-0">Professor at {college}</p>
              </div>
              <span className="h6 fw-light">{rating}<FaStar className="text-warning ms-1" /></span>
            </div>
            ...
            <div className="d-sm-flex justify-content-sm-between align-items-center">
              ...
              <ul className="list-inline mb-0 mt-3 mt-sm-0">
                ...
                return <li className="list-inline-item" key={idx}>
                      <Link className={clsx("mb-0 me-1", social.variant)} href=""><Icon /></Link>
                    </li>;
              })}
              </ul>
            </div>
      ...
      <Container>
        <Row className="mb-4 align-items-center">
          <Col sm={6} xl={4}>
            <form className="border rounded p-2">
              <div className="input-group input-borderless">
                ...
                <Button variant="primary" type="button" className="mb-0 rounded"><FaSearch /></Button>
              </div>
            </form>
          </Col>
          ...
          <Col sm={6} xl={2} className="mt-3 mt-xl-0 d-grid">
            <Button size="lg" variant="primary" className="mb-0">Filter Results</Button>
          </Col>
        </Row>
        <Row className="g-4 justify-content-center">
          {allInstructors.map((instructor, idx) => <Col lg={10} xl={6} key={idx}>
