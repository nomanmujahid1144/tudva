          ...
          <Col lg={5} className="position-relative mt-xl-0" id="fill-instructor-form">
            ...
            <Card className="card-body shadow p-4">
              ...
              <form className="row g-3 mt-2 position-relative z-index-9" onSubmit={handleSubmit(() => {})}>
                ...
                <Col xs={12}>
                  <button type="submit" className="btn btn-primary mb-0">Submit form</button>
                </Col>
              </form>
            </Card>
          </Col>
            ...
            <TabContainer defaultActiveKey={'tab-1'}>
              <Nav className="nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
                <NavItem className="me-2 me-lg-4" role="presentation">
                  <NavLink className="nav-link mb-2 mb-xl-0" id="course-pills-tab-1" eventKey="tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Become an Instructor</NavLink>
                </NavItem>
                <NavItem className="me-2 me-lg-4" role="presentation">
                  <NavLink className="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" eventKey="tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false">Instructor Role</NavLink>
                </NavItem>
                <NavItem className="me-2 me-lg-4" role="presentation">
                  <NavLink className="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" eventKey="tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-3" type="button" role="tab" aria-controls="course-pills-3" aria-selected="false">Start with Course</NavLink>
                </NavItem>
              </Nav>
                ...
                <TabPane className="tab-pane fade" eventKey="tab-2" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
                  ...
                  <ul className="list-group list-group-borderless mb-3">
                    <li className="list-group-item">
                      <FaCheckCircle size={15} className="text-success me-2" />The copy warned the Little blind text
                    </li>
                    <li className="list-group-item d-flex">
                      <div>
                        <FaCheckCircle size={15} className="text-success me-2 " /></div>Thar where it came from it would have been rewritten a thousand times and everything that was left from origin would be the world
                    </li>
                    <li className="list-group-item">
                      <FaCheckCircle size={15} className="text-success me-2" />Return to it&apos;s own,safe country
                    </li>
                  </ul>
                </TabPane>
