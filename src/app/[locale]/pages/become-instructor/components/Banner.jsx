...
import elementImg4 from '@/assets/images/element/04.svg';
      ...
      <Container className="position-relative">
        <Row className="g-4 align-items-center">
          <Col md={6}>
            ...
            <Button href="#fill-instructor-form" variant='primary' className=" mb-0">Start Teaching today</Button>
          </Col>
          <Col md={6} className="text-center">
            <Image src={elementImg4} className="h-300px h-xl-400px" alt='element' />
          </Col>
        </Row>
      </Container>
    </section>;
