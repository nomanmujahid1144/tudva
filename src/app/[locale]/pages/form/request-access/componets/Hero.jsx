      ...
      <Container>
        <Row className="g-4 g-sm-5 align-items-center py-4">
              ...
              <Col xs={12}>
                ...
                <div className="bg-body shadow rounded-3 p-2">
                  <div className="input-group">
                    ...
                    <button type="button" className="btn btn-blue mb-0 rounded-3">Request access!</button>
                  </div>
                </div>
              </Col>
            </form>
              ...
              <div>
                <ul className="avatar-group mb-3 mb-sm-0">
                  <li className="avatar avatar-sm">
                    <Image src={avatar1} className="avatar-img rounded-circle" alt='avatar' />
                  </li>
                  <li className="avatar avatar-sm">
                    <Image src={avatar2} className="avatar-img rounded-circle" alt='avatar' />
                  </li>
                  <li className="avatar avatar-sm">
                    <Image src={avatar3} className="avatar-img rounded-circle" alt='avatar' />
                  </li>
                  <li className="avatar avatar-sm">
                    <Image src={avatar4} className="avatar-img rounded-circle" alt='avatar' />
                  </li>
                  <li className="avatar avatar-sm">
                    <Image src={avatar5} className="avatar-img rounded-circle" alt='avatar' />
                  </li>
                  <li className="avatar avatar-sm">
          ...
          <Col lg={6} xl={7} className=" text-center">
            <Image className='w-auto' height={494} src={Image16} alt='decoration' />
          </Col>
        </Row>
      </Container>
    </section>;
