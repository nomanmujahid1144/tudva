...
const BookClass = () => {
  const avtars = [avatar1, avatar2, avatar3, avatar4, avatar5];
  ...
  return <section className="position-relative pt-4 pt-sm-5">

      <figure className="position-absolute top-0 end-0 mb-n5">
        <svg width="822.2px" height="301.9px" viewBox="0 0 822.2 301.9">
          <path className="fill-warning opacity-4" d="M752.5,51.9c-4.5,3.9-8.9,7.8-13.4,11.8c-51.5,45.3-104.8,92.2-171.7,101.4c-39.9,5.5-80.2-3.4-119.2-12.1 c-32.3-7.2-65.6-14.6-98.9-13.9c-66.5,1.3-128.9,35.2-175.7,64.6c-11.9,7.5-23.9,15.3-35.5,22.8c-40.5,26.4-82.5,53.8-128.4,70.7 c-2.1,0.8-4.2,1.5-6.2,2.2L0,301.9c3.3-1.1,6.7-2.3,10.2-3.5c46.1-17,88.1-44.4,128.7-70.9c11.6-7.6,23.6-15.4,35.4-22.8 c46.7-29.3,108.9-63.1,175.1-64.4c33.1-0.6,66.4,6.8,98.6,13.9c39.1,8.7,79.6,17.7,119.7,12.1C634.8,157,688.3,110,740,64.6 c4.5-3.9,9-7.9,13.4-11.8C773.8,35,797,16.4,822.2,1l-0.7-1C796.2,15.4,773,34,752.5,51.9z" />
        </svg>
      </figure>

      <figure className="position-absolute bottom-0 start-0 ms-9 d-none d-xxl-block">
      ...
      <figure className="fill-primary opacity-1 position-absolute top-50 start-0 translate-middle-y ms-n7 mt-n8 d-none d-xxl-block">
        <svg className="rotate-74">
      ...
      <Container className="position-relative z-index-9">
        <Row className="g-4 g-sm-5 justify-content-between">
          <Col lg={6} xl={5}>
            <h3>Get awesome experience in an online class with our superior instructor</h3>
            <Row className="mt-4">
              <Col xs={12} className="mb-5">
                <div className="d-flex align-items-center">
                  <div>
                    <div className="icon-xl bg-body shadow rounded-circle">
                      <Image src={child} className="h-40px" alt='child' />
                    </div>
                  </div>
                  <div className="ms-3">
                    <h5 className="mb-0">We care about students</h5>
                    <p className="text-truncate-2 mb-0">Man children rejoiced yet uncommonly his ten who. Yet uncommonly his ten who diminution astonished.</p>
                  </div>
                </div>
              </Col>
              <Col xs={12} className="mb-5">
                <div className="d-flex align-items-center">
                  <div>
                    <div className="icon-xl bg-body shadow rounded-circle">
                      <Image src={help} className="h-40px" alt='help' />
                    </div>
                  </div>
                  <div className="ms-3">
                    <h5 className="mb-0">Helping struggling students</h5>
                    <p className="text-truncate-2 mb-0">Children rejoiced yet uncommonly his ten who. Yet uncommonly his ten who diminution astonished.</p>
                  </div>
                </div>
              </Col>
            </Row>
            <div className="d-sm-flex justify-content-sm-between align-items-center">
              <div>
                <p className="mb-1">Our daily activated student</p>
              ...
              <div>
                ...
                <p className="mb-1">Based on 3265 ratings</p>

                <ul className="list-inline mb-1">
                  <li className="list-inline-item mb-0 h5">4.5/5.0</li>
          ...
          <Col lg={6} className="position-relative">
            ...
            <figure className="position-absolute start-100 top-100 mt-n7 d-none d-xl-block">
            ...
            <div className="bg-primary bg-opacity-10 rounded-3 p-4 p-sm-5">
              ...
              <form className="row g-4 g-sm-3 mt-2 mb-0" onSubmit={handleSubmit(() => {})}>
                <TextFormInput name="name" label="Name *" control={control} containerClassName="col-12" />

                <TextFormInput name="email" label="Email *" control={control} containerClassName="col-12" />

                <TextFormInput name="phoneNo" label="Mobile number *" control={control} containerClassName="col-12" />
                <Col xs={12}>
                  <label className="form-label">Select class *</label>
                  <ChoicesFormInput className="form-select js-choice" aria-label=".form-select-sm">
                ...
                <Col xs={12} className="d-grid">
                  <button type="submit" className="btn btn-lg btn-primary mb-0">Book a class</button>
                </Col>
              </form>
            </div>
          </Col>
