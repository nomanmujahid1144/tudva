        ...
        <Container>
          <Row className="g-4 g-lg-0 align-items-center">
            <Col md={6} className="align-items-center text-center">
              <Image src={contactImg} className="h-400px" alt="contact-image" />
              <div className="d-sm-flex align-items-center justify-content-center mt-2 mt-sm-4">
                ...
                <ul className="list-inline mb-0 ms-sm-2">
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-facebook" href=""><FaFacebookSquare className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-instagram" href=""><FaInstagram className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-twitter" href=""><FaTwitter className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-linkedin" href=""><FaLinkedinIn className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-dribbble" href=""><FaBasketballBall className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="fs-5 me-1 text-pinterest" href=""><FaPinterest className="fa-fw" /></Link> </li>
                </ul>
              </div>
            </Col>
            <Col md={6}>
              ...
              <form onSubmit={handleSubmit(() => {})}>
                ...
                <div className="d-grid">
                  <Button variant="primary" size="lg" className="mb-0" type="submit">Send Message</Button>
                </div>
              </form>
            </Col>
          </Row>
