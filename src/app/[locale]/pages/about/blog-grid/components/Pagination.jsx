...
const Pagination = () => {
  return <nav className="mt-5 d-flex justify-content-center" aria-label="navigation">
      <ul className="pagination pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
        <li className="page-item mb-0"><Link className="page-link" href="" tabIndex={-1}><FaAngleDoubleLeft /></Link></li>
        ...
        <li className="page-item mb-0"><Link className="page-link" href=""><FaAngleDoubleRight /></Link></li>
      </ul>
    </nav>;
};
