...
const Hero = () => {
  return <section>
      <Container>
        <Row className="g-4">
          <Col xs={10} className="text-center mx-auto position-relative">
            ...
            <h1 className="position-relative fs-2">Eduport education theme, built specifically for the education centers which is dedicated to teaching and involve learners.</h1>
          </Col>
        </Row>
        <Row className="g-4 mt-0 mt-lg-5">
          <Col xs={6} md={4}>
            <Row className="g-4">
              <Col xs={10} lg={6}>
                <Image className="rounded-4" src={about5} alt="about" />
              </Col>
              <Col xs={12}>
                <Image className="rounded-4" src={about3} alt="about" />
              </Col>
            </Row>
          </Col>
          <Col xs={6} md={4} className="position-relative">
            ...
            <Image className="rounded-4" src={about9} alt="about" />
          </Col>
          <Col md={4}>
            <Row className="g-4">
              <Col sm={6} md={12}>
                <div className="bg-grad rounded-4 p-5 text-start">
                  ...
                  <h3 className="text-white">“Be open to new ideas and approaches. Develop your problem-solving skills.”</h3>
                </div>
              </Col>
              <Col sm={6} md={12} lg={6}>
                <Image className="rounded-4" src={about10} alt="about10" />
              </Col>
            </Row>
          </Col>
        </Row>
