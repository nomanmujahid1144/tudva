...
const EventScheduleCard = ({
  ...
  return <AccordionItem eventKey={id} className="accordion-item mb-3">
      <AccordionHeader className="accordion-header font-base" id="heading-1">
        <div className="fw-bold">
          Day-{id}
          <span className="fw-normal ms-0 ms-sm-2">({day.toLocaleString('en-US', {
            weekday: 'long',
            day: '2-digit',
            month: 'short'
          })})</span>
        ...
        {events.map((items, idx) => <>
              <div className="d-flex align-items-center p-3">
                <div className="avatar avatar-sm flex-shrink-0">
                  <Image className="avatar-img rounded-circle" src={items.avatar} alt="avatar" />
                </div>
                <div className="ms-2">
                  <h6 className="mb-0 fw-normal"><a href="#">{items.title}<span>({items.time.toLocaleString('en-US', {
                    hour: '2-digit',
                    minute: '2-digit'
                  })})</span></a></h6>
                  <p className="small mb-0">by <a href="#" className="fw-bold text-body text-primary-hover"></a> {items.description}</p>
                </div>
              </div>
              {events.length - 1 != idx && <hr className="my-0" />}
              {items.isCoffeeBreak && <>
                  <div className="text-center p-3">
                    <h6 className="mb-0 fw-normal"><BsClock /> Coffee Break <span>({items.time.toLocaleString('en-US', {
                  hour: '2-digit',
                  minute: '2-digit'
                })})</span></h6>
                  </div>
              ...
              {items.isLunchBreak && <>
                  <div className="text-center p-3">
                    <h6 className="mb-0 fw-normal"><BsClock /> Lunch time <span>({items.time.toLocaleString('en-US', {
                  hour: '2-digit',
                  minute: '2-digit'
                })})</span></h6>
                  </div>
...
const MapCard = () => {
  return <Card className="card-body shadow">
      <a className="btn btn-primary w-100" href="#"> Buy ticket </a>
      <div className="mt-4">
        <ul className="list-unstyled mb-4">
          <li className="d-flex justify-content-between mb-3"> <span className="w-150px">Ticket Price:</span> <h6 className="text-end mb-0"> $210.00 </h6></li>
          <li className="d-flex justify-content-between mb-3"> <span className="w-150px">Entry fees:</span> <h6 className="text-end mb-0"> $1 per ticket </h6></li>
          <li className="d-flex justify-content-between mb-3"> <span className="w-150px">Address:</span> <h6 className="text-end mb-0"> 750 Sing Sing Rd, Horseheads, NY, 14845 </h6></li>
        </ul>
        <iframe className="w-100 d-block rounded-bottom" height={230} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095343008!2d-74.00425878428698!3d40.74076684379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sin!4v1586000412513!5m2!1sen!2sin" style={{
        border: 0
...
const EventDetailsContent = async () => {
  const eventScheduleData = await getAllEventSchedule();
              ...
              <Row className="g-4">
                <Col md={4}>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="avatar align-middle">
                      <div className="avatar-img rounded-1 bg-danger"><span className="text-white position-absolute top-50 start-50 translate-middle fw-bold">ZC</span></div>
                    </div>
                    <div className="ms-2">
                  ...
                  <div className="d-flex align-items-center">
                    <div className="avatar align-middle flex-shrink-0">
                      <div className="avatar-img rounded-2 bg-dark">
                        <span className="position-absolute top-50 start-50 translate-middle text-white"><BsGeoAltFill /></span>
                      </div>
                    </div>
                ...
                <Col md={4}>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="avatar align-middle flex-shrink-0">
                      <div className="avatar-img rounded-2 bg-dark">
                        <span className="position-absolute top-50 start-50 translate-middle text-white"><BsCalendarFill /></span>
                      </div>
                    </div>
                    <div className="ms-2">
                ...
                <Card className="card-body border">
                  <div className="d-xl-flex justify-content-between align-items-center">
                    <div className="hstack gap-2 mb-2 mb-xl-0">
                      ...
                      <div>
                        <CardTitle as={'h6'} className="mb-0"><a href="#">Dennis Barrett</a></CardTitle>
                ...
                <Card className="card-body border">
                  <div className="d-xl-flex justify-content-between align-items-center">
                    <div className="hstack gap-2 mb-2 mb-xl-0">
                      ...
                      <div>
                        <CardTitle as={'h6'} className="mb-0"><a href="#">Jacqueline Miller</a></CardTitle>
