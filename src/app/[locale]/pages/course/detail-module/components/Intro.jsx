...
const Intro = () => {
  return <section className="bg-blue py-7">
      <Container>
        <Row className="justify-content-lg-between">
          <Col lg={8}>
            ...
            <ul className="list-inline mb-5">
              ...
              <li className="list-inline-item h6 mb-0 text-white"><FaGlobe className="text-info me-2" />English</li>
            </ul>
          </Col>
          <Col lg={3}>
            <h6 className="text-white lead fw-light mb-3"><FaUserGraduate className="text-orange me-2" />12,155 already enrolled</h6>
            ...
            <div className="overflow-hidden mb-4">
              ...
              <div className="progress progress-sm bg-white bg-opacity-10 mb-1">
                <div className="progress-bar bg-white aos" role="progressbar" data-aos="slide-right" data-aos-delay={200} data-aos-duration={1000} data-aos-easing="ease-in-out" style={{
                width: '25%'
