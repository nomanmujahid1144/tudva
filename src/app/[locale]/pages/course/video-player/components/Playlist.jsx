          ...
          <Card className="card-body p-0">
            <div className="d-flex justify-content-between bg-light rounded-2 p-2 mb-2">
              ...
              <div className="d-flex">
                <Button variant="light" size="sm" className="btn-round me-2 mb-0"><BsPlayFill className="fa-fw" /></Button>
                <Button variant="light" size="sm" className="btn-round mb-0"><BsTrashFill className="fa-fw" /></Button>
              </div>
            </div>
            <div className="d-flex justify-content-between bg-light rounded-2 p-2 mb-2">
              <div className="d-flex align-items-center">
              ...
              <div className="d-flex">
                <Button variant="light" size="sm" className="btn-round me-2 mb-0"><BsPlayFill className="fa-fw" /></Button>
                <Button variant="light" size="sm" className="btn-round mb-0"><BsTrashFill className="bi fa-fw bi-trash-fill" /></Button>
              </div>
            </div>
          </Card>
        </div>
      ...
      <Card className="vh-100 overflow-auto rounded-0 w-280px w-sm-400px">
        ...
        <CardBody>
          <div className="d-sm-flex justify-content-sm-between">
            ...
            <Button variant="warning" size="sm" type="button" onClick={toggle}>
              <BsPencilSquare className="fa-fw me-2" />Add note
            </Button>
          </div>
          <hr />
          <Row>
        ...
        <CardFooter>
          <div className="d-grid">
            <Link href="/pages/course/detail" className="btn btn-primary-soft mb-0">Back to course</Link>
          </div>
        </CardFooter>
      </Card>
