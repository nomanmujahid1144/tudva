        ...
        <Card className="border bg-transparent rounded-3 mt-5">
          <CardHeader className="bg-transparent border-bottom">
            <div className="d-sm-flex justify-content-sm-between align-items-center">
              ...
              <Button variant='primary-soft' size='sm' className="mb-0">View all</Button>
            </div>
          </CardHeader>
          <CardBody>
              ...
              <table className="table table-dark-gray align-middle p-4 mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="w-60px">
                          <Image src={courses8} className="rounded" alt='courses' />
                        </div>
                    ...
                    <td>
                      <Button variant='success-soft' size='sm' className="btn-round me-1 mb-0"><FaRegEdit className="fa-fw" /></Button>
                      <button className="btn btn-sm btn-danger-soft btn-round mb-0"><FaTimes className="fa-fw" /></button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="w-60px">
                          <Image src={courses10} className="rounded" alt='courses' />
                        </div>
                        <h6 className="mb-0 ms-2 table-responsive-title">
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="w-60px">
                          <Image src={courses2} className="rounded" alt='courses' />
                        </div>
                        <h6 className="mb-0 ms-2 table-responsive-title">
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="w-60px">
                          <Image src={courses4} className="rounded" alt='courses' />
                        </div>
                        <h6 className="mb-0 ms-2 table-responsive-title">
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="w-60px">
                          <Image src={courses6} className="rounded" alt='courses' />
                        </div>
                        <h6 className="mb-0 ms-2 table-responsive-title">
