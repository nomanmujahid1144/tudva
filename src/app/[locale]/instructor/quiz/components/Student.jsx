...
const Student = () => {
  return <Card className="border bg-transparent rounded-3 mt-4">
          ...
          <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td>450/500</td>
                <td>
                  <Button variant='success-soft' className=" btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message"><FaRegEnvelope className="far fa-envelope" /></Button>
                </td>
              </tr>
              <tr>
                <td>
