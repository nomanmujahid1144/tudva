...
export const generateMetadata = async ({
  ...
  const event = await getProductById(params.productId);
  return {
            ...
            <Col xl={8}>
              ...
              <Row className="mb-3">
                <Col md={6}>
                  <ul className="list-group list-group-borderless">
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsCalendarFill className="bi fa-fw bi-calendar-fill text-primary me-2" />Published date:</span>
                      <span className="h6">12 Dec 2021</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><FaBook className="text-primary me-2" />Page count:</span>
                      <span className="h6">180</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><FaFont className="text-primary me-2" />Word count:</span>
                      <span className="h6">15879</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsTranslate className="text-primary me-2" />Language:</span>
                ...
                <Col md={6}>
                  <ul className="list-group list-group-borderless">
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsPersonCircle className="text-primary me-2" />Published by:</span>
                      <span className="h6">Dennis Barrett</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsEyeFill className="text-primary me-2" />Visited by:</span>
                      <span className="h6">18K</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsBagFill className="text-primary me-2" />Purchase by:</span>
                      <span className="h6">8245</span>
                    </li>
                    <li className="list-group-item px-0">
                      <span className="h6 fw-light"><BsStarFill className="text-primary me-2" />Rating/Review:</span>
