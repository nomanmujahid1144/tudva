...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaPeopleCarry, FaRegFileAlt, FaRegStar, FaReply, FaStar, FaStarHalfAlt, FaTruckMoving, FaTwitter } from 'react-icons/fa';
  ...
  return <>
      <div className="d-md-flex my-4">
        ...
        <div>
          ...
          <a href="#" className="text-body mb-0"><FaReply className="me-2" />Reply</a>
        </div>
      </div>
      <hr />
    </>;
      ...
      <TabContainer defaultActiveKey={1}>
        <Nav className=" nav-pills nav-pills-bg-soft px-3" id="book-pills-tab" role="tablist">
          <NavItem className="me-2 me-sm-4" role="presentation">
            <NavLink eventKey={1} className="mb-0 " id="book-pills-tab-1" data-bs-toggle="pill" data-bs-target="#book-pills-1" type="button" role="tab" aria-controls="book-pills-1" aria-selected="true">Author</NavLink>
          </NavItem>
          <NavItem className="me-2 me-sm-4" role="presentation">
            <NavLink eventKey={2} className="mb-0" id="book-pills-tab-2" data-bs-toggle="pill" data-bs-target="#book-pills-2" type="button" role="tab" aria-controls="book-pills-2" aria-selected="false">Reviews</NavLink>
          </NavItem>
          <NavItem className="me-2 me-sm-4" role="presentation">
            <NavLink eventKey={3} className="mb-0" id="book-pills-tab-3" data-bs-toggle="pill" data-bs-target="#book-pills-3" type="button" role="tab" aria-controls="book-pills-3" aria-selected="false">Shipping Method </NavLink>
          </NavItem>
        </Nav>
        <TabContent className="pt-4 px-3" id="book-pills-tabContent">
          <TabPane eventKey={1} className="fade show " id="book-pills-1" role="tabpanel" aria-labelledby="book-pills-tab-1">
            <Row className=" g-4">
              <Col md={3}>
                <Image src={instructor8} className="rounded-3" alt='instructor' />
              </Col>
              <Col md={9}>
                <div className="d-sm-flex justify-content-sm-between">
                  ...
                  <ul className="list-inline mb-0">
                    <li className="list-inline-item">
                      <a className="mb-0 me-1 text-facebook" href="#"><FaFacebookF /></a>
                    </li>&nbsp;
                    <li className="list-inline-item">
                      <a className="mb-0 me-1 text-instagram-gradient" href="#"><FaInstagram className='text-danger' /></a>
                    </li>&nbsp;
                    <li className="list-inline-item">
                      <a className="mb-0 me-1 text-twitter" href="#"><FaTwitter /></a>
                    </li>&nbsp;
                    <li className="list-inline-item">
                      <a className="mb-0 text-linkedin" href="#"><FaLinkedinIn /></a>
                    </li>
                  </ul>
                </div>
          ...
          <TabPane eventKey={2} className="fade" id="book-pills-2" role="tabpanel" aria-labelledby="book-pills-tab-2">
            <Row className=" mb-4">
              ...
              <Col md={8}>
                <Row className=" align-items-center text-center">
                  {progress.map((item, idx) => <Fragment key={idx}>
                      <Col xs={6} sm={8}>
                        <ProgressBar variant='warning' className="progress-sm bg-opacity-15 " role="progressbar" now={item} />
                      </Col>
                      <Col xs={6} sm={4}>
                        <ul className="list-inline mb-0">
                          {Array(Math.floor(progress.length - idx)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaStar size={14} className="text-warning" /></li>)}
                          {!Number.isInteger(progress.length - idx) && <li className="list-inline-item me-1 small"> <FaStarHalfAlt size={14} className="text-warning" /> </li>}
                          {progress.length - idx < 5 && Array(5 - Math.ceil(progress.length - idx)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small"><FaRegStar size={14} className="text-warning" /></li>)}
                        </ul>
                      </Col>
                    </Fragment>)}
                </Row>
            ...
            <Row>
              {reviewData?.map((item, idx) => <ReviewCard key={idx} {...item} />)}
            </Row>
            <div className="mt-2">
