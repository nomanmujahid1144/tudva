...
const CounterCard = ({
  ...
  return <div className={`d-flex justify-content-center align-items-center p-4 bg-${variant} bg-opacity-15 rounded-3`}>
...
const Counter = () => {
  return <Row className="mb-4">
      {counterData.map((item, idx) => <Col sm={6} lg={4} className='mb-3' key={idx}>
            <CounterCard {...item} />
          </Col>)}
