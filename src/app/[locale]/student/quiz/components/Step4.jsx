...
const Step4 = ({
  ...
  return <form onSubmit={goToNextStep} id="step-4" role="tabpanel" className="content fade" aria-labelledby="steppertrigger4">
      ...
      <div className="d-flex justify-content-center mt-3">
        <button type="submit" className="btn btn-success next-btn mb-0">View result</button>
      </div>
    </form>;
};
