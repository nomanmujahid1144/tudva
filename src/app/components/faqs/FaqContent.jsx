...
import { questionsData, topicData } from '../data/faqData';
...
const QuestionsCard = ({
  ...
  return <AccordionItem eventKey={id} className=" mb-3">
...
const TopicCard = ({
  ...
  return <div className="d-flex justify-content-between align-items-center mb-2">
      <a href="#" className="h6 fw-light"><FaCaretRight className="text-orange me-2" />{title}</a>
        ...
        <Row className="g-4 g-md-5">
          <Col lg={8}>
            ...
            <Accordion className="accordion accordion-icon accordion-bg-light" id="accordionExample2">
              {questionsData?.map((item, idx) => <QuestionsCard {...item} key={idx} />)}
            </Accordion>
          </Col>
          <Col lg={4}>
              ...
              <Col xs={12} sm={6} lg={12}>
                <div className="mb-4">
                  <div className="d-flex justify-content-between align-items-center bg-info bg-opacity-10 rounded p-2 position-relative mb-3">
                    ...
                    <a href="#" className="badge bg-info stretched-link">2D ago</a>
                  </div>
                  <div className="d-flex justify-content-between align-items-center bg-danger bg-opacity-10 rounded p-2 position-relative mb-3">
                    ...
                    <a href="#" className="badge bg-danger stretched-link">15,525</a>
                  </div>
                  <div className="d-flex justify-content-between align-items-center bg-success bg-opacity-10 rounded p-2 position-relative mb-3">
                    ...
                    <a href="#" className="badge bg-success stretched-link">12536</a>
                  </div>
                </div>
                <Card className="card-body shadow p-4 mb-4">
                  <h4 className="mb-3">Related Topic</h4>
                  {topicData?.map((item, idx) => <TopicCard {...item} key={idx} />)}
                </Card>
              </Col>
              <Col xs={12} sm={6} lg={12}>
