...
import { topITCourses } from "../data/coursesData";
...
const CourseCard = ({
  ...
  return <Card className="card-metro overflow-hidden rounded-3">
      <Image src={image} alt="course" />
      <div className="card-img-overlay d-flex">
        <div className="mt-auto card-text">
          <a href="#" className="text-white mt-auto h5 stretched-link">{name}</a>
...
const TopCourses = () => {
  return <section>
      <Container>
        ...
        <Row className="g-4">
          {topITCourses.map((course, idx) => <Col sm={6} lg={4} xl={3} key={idx}>
