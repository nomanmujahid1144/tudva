...
const Hero = () => {
  return <section className="position-relative pb-0 pb-sm-5 mt-lg-5">
    ...
    <Container>
      <Row className="align-items-center justify-content-xl-between g-4 g-md-5">
        <Col lg={6} xl={6} className="position-relative z-index-1 text-center text-lg-start mb-2 mb-xl-0">
          <h6 className="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">the easiest way to your success</h6>
          <h1 className="mb-4 display-5 text-right d-block text-center">
            <span className="me-5r">Lifelong</span>
            <span className="d-block text-center">learning</span>
            <span className="d-block text-center">2.0</span>
          ...
          <p className="mb-3">
            ...
            Discover a variety of courses, design your
            own learning day and become part of a
            committed community.
          </p>
        </Col>
        <Col lg={6} xl={6} className="text-center position-relative">
          <div className=" position-relative d-flex justify-content-center">
            {/* <div className="bg-warning rounded-4 border border-white border-5 w-90 h-150px h-sm-250px shadow" /> */}
