...
const CoursesOverview = () => {
  ...
  const courses = [
    { id: '1', title: 'JavaScript - Beginners Course', module: 'Module 4/10: Hello World', imageUrl: course1 },
    ...
    { id: "5", title: t('weekPlan.noCourse'), module: t('weekPlan.chooseTopic'), imageUrl: course1 },
                ...
                >
                  <div className="accordion-body">
                    ...
                    <h5 className="text-center">
                      {t('weekPlan.learningDay', { date: 'Friday 28, 2025', week: 8 })}
                    </h5>
                    <div className="w-100 d-flex justify-content-center">
                      <Row className='w-100 w-md-75'>
                        {courses.map((course, index) => (
                          <Col xs={12} sm={6} md={12} key={course.id} className="mb-3">
                            <CoursePreview
                              title={course.title}
