...
const HelpCenterDetails = () => {
  ...
  return <section>
      <Container data-sticky-container>
        <Row className="g-4">
          <Col md={3}>
            <Sticky disabled={width <= 768} topOffset={80} bottomOffset={0} boundaryElement="div.row" hideOnBoundaryHit={false} stickyStyle={{
            transition: '0.2s all linear'
              ...
              <div id="nav-scroll" className="navbar">
                <nav className="nav nav-pills nav-pill-soft flex-column">
                  ...
                  return <Link key={idx} className={clsx('nav-link', hash == item.id && 'active')} href={item.id}><Icon className="me-2" />{item.title}</Link>;
                })}
                </nav>
              </div>
            </Sticky>
              ...
              <div id="item-1">
                <Card className="bg-transparent">
                  ...
                  <CardBody className="px-0 pb-0">
                    ...
                    <p className="mb-0">Improved own provided blessing may peculiar domestic. Sight house has sex never. No visited raising gravity outward subject my cottage Mr be. Hold do at tore in park feet near my case. Invitation at understood occasional sentiments insipidity inhabiting in. <u> Off melancholy alteration principles old. </u>Is do speedily kindness properly oh. Respect article painted cottage he is offices parlors. </p>
                  </CardBody>
                </Card>
              </div>
                ...
                <Card className="bg-transparent">
                  ...
                  <CardBody className="px-0">
                    ...
                    <ul className="list-group list-group-borderless mb-3">
                      <li className="list-group-item d-flex pb-0"><Link href="#" className="mb-0">How do I logout on eduport</Link></li>
                      <li className="list-group-item d-flex pb-0"><Link href="#" className="mb-0">How do T permanently delete my account</Link></li>
                      <li className="list-group-item d-flex pb-0"><Link href="#" className="mb-0">What&apos;s the difference between deactivating and deleting my account</Link></li>
                      <li className="list-group-item d-flex pb-0"><Link href="#" className="mb-0">Why did my payment in a eduport message fail?</Link></li>
                    </ul>
                  </CardBody>
                  <CardFooter className="bg-transparent border-0 py-0 px-0">
                    <div className="border p-3 rounded d-sm-flex align-items-center justify-content-between text-center">
                      ...
                      <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label className="btn btn-outline-light btn-sm mb-0" htmlFor="btnradio3"><FaRegThumbsUp className="me-1" /> Yes</label>
                        <input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                        <label className="btn btn-outline-light btn-sm mb-0" htmlFor="btnradio4"> No <FaRegThumbsDown className="ms-1" /></label>
                      </div>
                    </div>
                  </CardFooter>
                </Card>
              ...
              <div id="item-3">
                <Card className="bg-transparent">
                  ...
                  <CardBody className="px-0">
                    ...
                    <ul className="list-group list-group-borderless mb-3">
                      <li className="list-group-item d-flex pb-0"><a href="#" className="mb-0">About daily budgets</a></li>
                      <li className="list-group-item d-flex pb-0"><a href="#" className="mb-0">About lifetime budgets</a></li>
                      <li className="list-group-item d-flex pb-0"><a href="#" className="mb-0">When you pay for Eduport ads</a></li>
                    </ul>
                  </CardBody>
                  <CardFooter className="bg-transparent border-0 py-0 px-0">
                    <div className="border p-3 rounded d-sm-flex align-items-center justify-content-between text-center">
