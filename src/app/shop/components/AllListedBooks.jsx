...
export const BooksCard = ({
  ...
  return <Card className="shadow h-100">
      <div className="position-relative">
        <Image src={image} className="card-img-top" alt="book image" />
        <div className="card-img-overlay d-flex z-index-0 p-3">
          <div className="w-100 mb-auto d-flex justify-content-end">
            <div className="icon-md bg-dark rounded-circle fs-5">
              <a href="#" className="text-white"><Icon /></a>
            </div>
          </div>
        </div>
      </div>
      <CardBody className="px-3">
        <CardTitle className="mb-0">
          <Link href={`/shop/product-detail/${id}`} className="stretched-link">{title}</Link>
        </CardTitle>
      </CardBody>
        ...
        <Row>
          <Col xs={12}>
            ...
            <Row className=" g-4">
              ...
              {bookData.map((item, idx) => <Col sm={6} lg={4} xl={3} key={idx}>
                    <BooksCard {...item} />
                  </Col>)}
            </Row>
            <Col xs={12}>
              <nav className="mt-4 d-flex justify-content-center" aria-label="navigation">
                <ul className="pagination pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
                  <li className="page-item mb-0"><a className="page-link" href="#" tabIndex={-1}><FaAngleDoubleLeft /></a></li>
                  ...
                  <li className="page-item mb-0"><a className="page-link" href="#"><FaAngleDoubleRight /></a></li>
                </ul>
              </nav>
            </Col>
          </Col>
