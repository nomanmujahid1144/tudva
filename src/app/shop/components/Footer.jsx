        ...
        <div className="py-3">
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body text-primary-hover"> Copyrights ©2024 Eduport. Build by <Link href={developedByLink} target="_blank" className="text-body">Stackbros</Link></div>
