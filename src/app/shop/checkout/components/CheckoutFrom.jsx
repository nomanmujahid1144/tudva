...
import { Accordion, AccordionBody, AccordionHeader, AccordionItem, Alert, Button, Card, CardBody, CardTitle, Col, Container, Row } from 'react-bootstrap';
...
const CheckoutProductCard = ({
  ...
  return <>
      <Row className="g-3">
        <Col sm={4}>
          <Image className="rounded" src={image} alt='courses' />
        </Col>
        <Col sm={8}>
          ...
          <div className="d-flex justify-content-between align-items-center mt-3">
            ...
            <div className="text-primary-hover">
              <a href="#" className="text-body me-2"><BsTrash className="me-1" />Remove</a>
              <a href="#" className="text-body me-2"><BsPencilSquare className="me-1" />Edit</a>
            </div>
          </div>
        </Col>
      </Row>
        ...
        <Row className="g-4 g-sm-5">
          <Col xl={8} className="mb-4 mb-sm-0">
            ...
            <Card className="card-body shadow p-4">
              ...
              <form className="row g-3 mt-0" onSubmit={handleSubmit(() => {})}>
                ...
                <TextFormInput name="email" placeholder="Email" containerClassName="col-md-6 bg-light-input" label="Email address *" control={control} />
                <TextFormInput name="phoneNo" placeholder="Mobile number" containerClassName="col-md-6 bg-light-input" label="Mobile number *" control={control} />
                ...
                <TextFormInput name="postalCode" placeholder="PIN code" containerClassName="col-md-6 bg-light-input" label="Postal code *" control={control} />
                <TextFormInput name="address" placeholder="Address" containerClassName="col-md-6 bg-light-input" label="Address *" control={control} />
                <Col xs={12}>
                  <label className="form-label">Your saved cards *</label>
                  <Row className="g-2">
                    <Col xs={2} sm={1} className="border rounded me-2">
                      <a href="#"><Image src={mastercardImg} alt='mastercard' /></a>
                    </Col>
                    <Col xs={2} sm={1} className="border rounded me-2">
                      <a href="#"><Image src={visaCardImg} alt='visa' /></a>
                    </Col>
                    <Col xs={2} sm={1} className="border rounded me-2">
                      <a href="#"><Image src={aeCardImg} alt='aeCardImg' /></a>
                    </Col>
                  </Row>
                </Col>
                        ...
                        <form className="row g-3">
                          <Col xs={12} className="">
                            ...
                            <div className="position-relative">
                              ...
                              <Image src={visaCardImg} className="w-40px position-absolute top-50 end-0 translate-middle-y me-2 d-none d-sm-block" alt='visa' />
                            </div>
                          </Col>
                          <Col md={6}>
          ...
          <Col xl={4}>
            <Row className="mb-0">
              ...
              <Col md={6} xl={12}>
                <Card className="bg-blue p-3 position-relative overflow-hidden" style={{
                background: 'url(assets/images/pattern/05.png) no-repeat center center',
                backgroundSize: 'cover'
                  ...
                  <CardBody>
                    ...
                    <Button variant='warning' size='sm' className="mb-0">Purchase Premium</Button>
                  </CardBody>
                </Card>
              </Col>
            </Row>
