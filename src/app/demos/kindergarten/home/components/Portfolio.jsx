  ...
  return <section>
      <Container>
        ...
        <Row className="g-4 filter-container overflow-hidden" data-isotope="{&quot;layoutMode&quot;: &quot;masonry&quot;}">
          {portfolioImages.map((image, idx) => <Col xs={6} md={4} lg={3} className="grid-item" key={idx}>
            <Card className="overflow-hidden">
              <div className="card-overlay-hover">
                <Image src={image} className="rounded-3" alt="course image" />
              </div>
              <GlightBox className="card-element-hover position-absolute w-100 h-100" data-glightbox data-gallery="gallery" href={image.src}>
