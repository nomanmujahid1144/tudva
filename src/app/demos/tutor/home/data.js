...
export const services = [{
  ...
  students: 268,
  features: ["Private and public classes", "Online and offline classes", "Mon to Sat classes"]
}, {
  image: element18,
  title: "College tuition",
  students: 780,
  features: ["Only private classes", "Online and offline classes", "Sat and Sun classes"]
}, {
  image: element20,
  title: "Language tuition",
  students: 576,
  features: ["Private and public classes", "Online and offline classes"]
}];
export const faqs = [{
