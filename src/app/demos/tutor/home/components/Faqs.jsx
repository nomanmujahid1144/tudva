...
const Faqs = () => {
  return <section className="position-relative overflow-hidden pt-0 pt-sm-5">
      <Container>
        ...
        <Row>
          <Col lg={10} xl={8} className="mx-auto text-center position-relative">
            <figure className="position-absolute top-0 start-0 translate-middle ms-8">
              <svg>
                <path className="fill-success" d="M137.7,53.1c9.6,29.3,1.8,64.7-20.2,80.7s-58.1,12.6-83.5-5.8C8.6,109.5-6.1,76.1,2.4,48.7 C10.8,21.1,42.2-0.7,71.5,0S128.1,23.8,137.7,53.1z" />
              </svg>
            </figure>
            ...
            <Accordion defaultActiveKey='0' className="accordion-icon accordion-shadow mt-4 text-start position-relative" id="accordionExample2">
              {faqs.map((faq, idx) => <AccordionItem eventKey={`${idx}`} className="mb-3" key={idx}>
                  <AccordionHeader>
