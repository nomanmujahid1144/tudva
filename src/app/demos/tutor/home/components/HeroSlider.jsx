...
const HeroSlider = () => {
  ...
  return <div className="tiny-slider arrow-round arrow-dark arrow-hover arrow-xs">
        ...
        <div>
          <div className="d-md-flex my-2">
            ...
            <div className="flex-grow-1 mt-2 mt-md-0">
              <p className="mb-2">&quot;Make my life easier and organized conviction For every delay in they Extremity now strangers contained breakfast&quot; </p>
              <h6 className="me-3 mb-0">Jacqueline Miller <span className="small mb-0 text-body">(Student)</span></h6>
            </div>
          </div>
        </div>
        <div>
          <div className="d-md-flex my-2">
            ...
            <div className="flex-grow-1 mt-2 mt-md-0">
              ...
              <h6 className="me-3 mb-0">Dennis Barrett <span className="small mb-0 text-body">(Student)</span></h6>
            </div>
          </div>
        </div>
      </TinySlider>
