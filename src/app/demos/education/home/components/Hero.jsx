...
const Hero = () => {
  return <section className="pt-0 position-relative overflow-hidden h-700px h-sm-600px h-lg-700px rounded-top-4 mx-2 mx-md-4" style={{
    backgroundImage: `url(${bgImg3.src})`,
          ...
          <Col sm={10} lg={8} xl={6} className="all-text-white my-5 mt-md-0">
            <div className="py-0 py-md-5 my-5">
              <div className="d-inline-block bg-white px-3 py-2 rounded-pill mb-3">
                <p className="mb-0 text-dark"><span className="badge text-bg-success rounded-pill me-1">New</span>	One to one video call using web browser</p>
              </div>
              ...
              <div className="d-sm-flex align-items-center mt-4">
                <a href="#" className="btn btn-primary me-2 mb-4 mb-sm-0">Get Started</a>
                <div className="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                  <GlightBox data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-round btn-white-shadow text-danger me-7 mb-0 overflow-visible">
