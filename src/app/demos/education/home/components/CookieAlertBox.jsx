...
const CookieAlertBox = () => {
  ...
  return <Alert show={isTrue} onClose={toggle} dismissible className="alert-light fade show position-fixed start-0 bottom-0 z-index-99 rounded-3 shadow p-4 ms-3 mb-3 col-10 col-md-4 col-lg-3 col-xxl-2" role="alert">
      <div className="text-dark text-center">
        <Image src={element27} className="h-50px mb-3" alt="cookie" />
