...
import medalImg from '@/assets/images/element/medal.svg';
import medalBadge from '@/assets/images/element/medal-badge.png';
import backgroundImg from '@/assets/images/bg/06.jpg';
const Hero = () => {
  return <section className="position-relative overflow-hidden pb-0 pb-sm-5">
      <Container>
        <Row className="d-lg-flex justify-content-lg-between g-4 g-md-5">
          <Col lg={7} className="position-relative z-index-1 mb-2">
            <h1 className="mb-4 display-4">
              <span>
                <svg className="fill-warning" width={103} height={100} viewBox="0 0 103 100">
                  ...
                  <path d="M90.0771 28.9603C89.5344 29.4413 88.7314 29.5071 88.1298 29.0713C87.635 28.7562 83.0688 25.9128 78.8126 31.1931C78.2562 31.9017 77.2257 31.9538 76.5706 31.4577C75.8621 30.9014 75.81 29.8708 76.306 29.2158C81.3597 23.0131 87.48 24.6943 90.0002 26.4442C90.769 26.9471 90.9349 27.9845 90.3786 28.693C90.258 28.7999 90.1374 28.9068 90.0771 28.9603Z" />
                  <path d="M26.6015 44.2033C28.5257 46.3739 28.3271 49.6725 26.1565 51.5966C23.9859 53.5208 20.6873 53.3222 18.7632 51.1516C16.8391 48.981 17.0376 45.6824 19.2082 43.7583C21.3788 41.8342 24.6774 42.0327 26.6015 44.2033Z" />
                  <path d="M56.8095 17.4259C58.7337 19.5965 58.5351 22.895 56.3645 24.8192C54.1939 26.7433 50.8953 26.5447 48.9712 24.3741C47.0471 22.2035 47.2456 18.905 49.4162 16.9808C51.5869 15.0567 54.8854 15.2552 56.8095 17.4259Z" />
                </svg>
              </span>
               School Might be&nbsp;
              <span>Closed, Not Your</span>
              <span className="position-relative d-inline-block">Curiosity
                <span className="position-absolute top-50 start-50 translate-middle z-index-n1 d-none d-sm-block">
                  <svg className="fill-orange" width={303} height={86} viewBox="0 0 303 86">
            ...
            <p className="mb-3 col-lg-8">We are so eager to be working with kids and making a difference in their careers. Being a mentor is what we have always wanted to be.</p>
            <Button variant="blue" size="lg" className="mb-0">Apply Now</Button>
          </Col>
          <Col lg={5} xxl={3} className="position-relative">
            <h4 className="mb-4">Our 2023 Top-Ranked Student</h4>
            {topStudents.map((student, idx) => <div className={clsx("d-flex align-items-center", {
            "mb-3": topStudents.length - 1 != idx
          })} key={idx}>
                <div className="avatar avatar-xl">
                  <Image className="avatar-img rounded-circle" src={student.avatar} alt="avatar" />
                  <div className="position-absolute bottom-0 end-0">
                    <Image src={medalBadge} className="position-relative" alt="medal" />
                    <span className="fw-bold text-dark smaller position-absolute top-50 start-50 translate-middle">{student.rank}<sup>st</sup></span>
                  </div>
                </div>
                <div className="ms-3">
                  <h5 className="mb-1">{student.name}</h5>
                  <p className="mb-0">{student.standard} Board Exam</p>
                </div>
              </div>)}
          </Col>
        </Row>
        <Row className="g-lg-5 align-items-center mt-5 mt-lg-0">
          <Col lg={6} xl={5}>
            <ul className="list-inline vstack gap-4 flex-wrap mb-4">
              <li className="list-inline-item border-bottom me-0">
                <div className="d-sm-flex justify-content-between align-items-center mb-3">
                  <div className="d-sm-flex align-items-center">
                    <Image height={70} width={73} src={medalImg} className="me-3 mb-2 mb-sm-0 h-70px" alt="medal" />
                    <h5 className="mb-2 mb-sm-0">Best school of the year</h5>
                  </div>
              ...
              <li className="list-inline-item">
                <div className="d-sm-flex justify-content-between align-items-center mb-3">
                  <div className="d-sm-flex align-items-center">
                    <Image height={70} width={73} src={medalImg} className="me-3 mb-2 mb-sm-0 h-70px" alt="medal-image" />
                    <h5 className="mb-2 mb-sm-0">Best discipline school of the year</h5>
                  </div>
                  <h5 className="mb-0">2023</h5>
                </div>
              </li>
            </ul>
          </Col>
          <Col lg={6} xl={7} className="position-relative mt-5 mt-lg-0">
            <figure className="position-absolute top-0 start-0 translate-middle ms-3">
              <svg className="fill-danger" width={79} height={99} viewBox="0 0 79 99">
            ...
            <Image src={backgroundImg} className="rounded-3" alt="bg-image" />
          </Col>
        </Row>
      </Container>
    </section>;
