        ...
        <Row className="mb-3 mb-sm-4">
          <Col xs={12} className="mx-auto text-center">
            <h2 className="h1">
              ...
              <span className="position-relative z-index-1">News &amp; Blogs
        ...
        <Row className="g-4 justify-content-between">
          <Col md={5}>
            <Card className="bg-transparent">
              <Image src={event18} className="card-img" alt="event-image" />
              <div className="card-body px-3">
                <h4><a href="#" className="stretched-link">Around the web: 20 fabulous infographics about business</a></h4>
                  ...
                  <Row className="align-items-center">
                    ...
                    <Col sm={8} lg={8}>
                      <CardBody className="p-0">
                        <CardTitle><Link href="" className="stretched-link">{blog.title}</Link></CardTitle>
