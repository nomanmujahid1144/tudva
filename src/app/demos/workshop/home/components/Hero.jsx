        ...
        <Row className="g-4 g-md-5 align-items-center justify-content-between	mb-xxl-n7">
          <Col lg={3} xl={4} xxl={3} className="d-none d-lg-block">
            <Row className="g-md-5 align-items-center ms-n6">
              <Col xs={6}>
                <Image src={heroImg7} className="rounded-3 mt-6 mb-5" alt="hero-image" />
                <Image src={heroImg6} className="rounded-3" alt="hero-image" />
              </Col>
              <Col xs={6} className="position-relative">
                <Image src={heroImg5} className="rounded-3" alt="hero-image" />
                <Image width={39} height={60} src={element17} className="h-60px position-absolute top-0 start-0 ms-3 mt-n3" alt="element" />
              </Col>
            </Row>
          </Col>
          ...
          C57.5,58.1,60.8,63.5,59.8,64.9z" />
            ...
            <div className="d-sm-flex align-items-center justify-content-center">
              <a href="#" className="btn btn-lg btn-warning me-2 mb-4 mb-sm-0">View Courses<BsArrowRight className="ms-2" /></a>
          ...
          <Col lg={3} xl={4} xxl={3}>
            <Row className="g-4 align-items-center me-n4">
              <Col xs={4}>
                <Image src={heroImg1} className="rounded-3" alt="hero-image" />
              </Col>
              <Col xs={5} className="position-relative">
                <Image src={heroImg2} className="rounded-3 mb-5" alt="hero-image" />
                <Image src={heroImg3} className="rounded-3 mb-n5" alt="hero-image" />
              ...
              <Col xs={3}>
                <Image src={heroImg4} className="rounded-3 mt-7 mb-5" alt="hero-image" />
                <Image src={heroImg8} className="rounded-3 mb-n8" alt="hero-image" />
              </Col>
            </Row>
          </Col>
        </Row>
