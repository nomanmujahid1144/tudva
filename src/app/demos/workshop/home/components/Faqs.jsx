      ...
      <Container>
        <Row className="g-4">
          <Col lg={6} xl={5}>
            ...
            <p className="mb-0">We are answering the most frequent questions. No worries if you do not find the exact one. You can find out more by searching or continuing by clicking the button below or directly <a href="#" className="text-decoration-underline">Contact our supports</a></p>
          </Col>
          <Col lg={6} className="ms-xl-auto">
            <Accordion defaultActiveKey='0' className="accordion-icon accordion-bg-light" id="accordionFaq">
              {faqsData.map((faq, idx) => <AccordionItem eventKey={`${idx}`} className="mb-2" key={idx}>
                  <AccordionHeader>
