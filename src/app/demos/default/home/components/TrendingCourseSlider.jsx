...
const TrendingCourseCard = ({
  ...
  return <Card className="action-trigger-hover border bg-transparent">
            ...
            {price === 0 && <div className="ribbon mt-3"><span>Free</span></div>}
            <CardBody className="pb-0">
                <div className="d-flex justify-content-between mb-3">
          <span className="hstack gap-2">
            <a href="#" className="badge bg-primary bg-opacity-10 text-primary">{category}</a>
            <a href="#" className="badge text-bg-dark">{badge.text}</a>
          </span>
                ...
                <div className="d-flex justify-content-between mb-2">
                    <div className="hstack gap-2">
                        <p className="text-warning m-0">{rating.star}<FaStar className="text-warning ms-1" /></p>
            ...
            <CardFooter className="pt-0 bg-transparent">
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="mb-0 ms-2"><a href="#" className="h6 fw-light mb-0">{name}</a></p>
                    </div>
                    <div>
                        <h4 className="text-success mb-0 item-show">{price === 0 ? "Free" : `${currency}${price}`}</h4>
                        <a href="#" className="btn btn-sm btn-success-soft item-show-hover"><FaShoppingCart className="me-2" />Add to cart</a>
                    </div>
                </div>
            </CardFooter>
        </Card>;
