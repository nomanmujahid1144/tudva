          ...
          <Col xl={7} className="order-2 order-xl-1">
                ...
                <div className="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                  ...
                  <div className="d-flex align-items-center mb-3">
                    <div className="avatar avatar-sm">
                      <Image className="avatar-img rounded-1" src={avatar9} alt="avatar" />
                    </div>
                    <div className="ms-2">
                  ...
                  <div className="d-flex align-items-center mb-3">
                    <div className="avatar avatar-sm">
                      <Image className="avatar-img rounded-1" src={avatar4} alt="avatar" />
                    </div>
                    <div className="ms-2">
                  ...
                  <div className="d-flex align-items-center">
                    <div className="avatar avatar-sm">
                      <Image className="avatar-img rounded-1" src={avatar2} alt="avatar" />
                    </div>
                    <div className="ms-2">
            ...
            <Row className="mt-5 mt-xl-0">
              <Col xs={7} className="mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                ...
                background: `url(${pattern2.src}) no-repeat center center`,
