...
const Hero = () => {
  ...
  return <section className="position-relative overflow-hidden pt-5 pt-lg-3">
      ...
      <Container>
        <Row className="align-items-center g-5">
          <Col lg={5} xl={6} className="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
            ...
            <ul className="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
              <li className="list-inline-item me-2 icons-center"> <BsPatchCheckFill className="me-1 text-dark" />Learn with experts</li>
              <li className="list-inline-item me-2 icons-center"> <BsPatchCheckFill className="me-1 text-dark" />Get certificate</li>
              <li className="list-inline-item icons-center"> <BsPatchCheckFill className="me-1 text-dark" />Get membership</li>
            </ul>
          ...
          <Col lg={7} xl={6} className="text-center position-relative">
            ...
            <div className="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
              <div className="d-flex justify-content-between align-items-center">
                <span className="icon-lg bg-warning rounded-circle"><FaEnvelope className="text-white" /></span>
                <div className="text-start ms-3">
                  <h6 className="mb-0 text-white">Congratulations <span className="ms-4"><FaCheckCircle className="text-success" /></span></h6>
            ...
            backgroundSize: 'cover'
              ...
              <ul className="avatar-group mb-0">
                {students.map((student, idx) => <li className="avatar avatar-sm" key={idx}>
                    <Image className="avatar-img rounded-circle border-white" src={student} alt="avatar" />
                  </li>)}
