      ...
      <Container>
        <Row className="align-items-center justify-content-xl-between g-4 g-md-5">
          <Col lg={7} xl={5} className="position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
            ...
            <h1 className="mb-4 display-5">Develop the skillset &amp; your&nbsp;
              <span className="position-relative d-inline-block">Bright Future
            ...
            <p className="mb-3">The most reliable online courses and certifications in marketing, information technology, programming, and data science.
            </p>
            <form className="border rounded p-2 mb-4">
              <div className="input-group">
                ...
                <button type="button" className="btn btn-primary mb-0 rounded"><FaSearch /></button>
              </div>
            </form>
            <Counter />
          </Col>
          <Col lg={5} xl={6} className="text-center position-relative">
            ...
            <Card className="p-3 card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
              <div className="d-flex justify-content-between">
                <div className="avatar">
                  <Image className="avatar-img rounded-circle shadow" src={avatar4} alt="avatar" />
                </div>
                <div className="text-start ms-3">
                  <h6 className="mb-0">Java Development class</h6>
                  <p className="mb-0 small text-body">Today at 1:00 pm</p>
                  <Button size="sm" variant="danger-soft" className="mt-2 mb-0">Join now</Button>
                </div>
              </div>
            </Card>
            ...
            <div className=" position-relative">
              ...
              <Image src={element6} className="position-absolute bottom-0 start-50 translate-middle-x" alt="element" />
            </div>
          </Col>
        </Row>
      </Container>
