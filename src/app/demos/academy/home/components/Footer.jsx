      ...
      <Container>
        <Row className="g-4">
          <Col lg={3}>
            ...
            <p className="my-3 text-body-secondary">Eduport education theme, built specifically for the education centers which is dedicated to teaching and involving learners. </p>
            <ul className="list-inline mb-0 mt-3">
              {socialMediaLinks.map((item, idx) => {
              const Icon = item.icon;
              return <li className="list-inline-item" key={idx}> <Link className={clsx("btn btn-white btn-sm shadow px-2", item.variant)} href=""><Icon className="fa-fw" /></Link> </li>;
            })}
            </ul>
          </Col>
          <Col lg={6}>
          ...
          <Col lg={3}>
            ...
            <p className="mb-0 text-body-secondary">Email:<span className="h6 fw-light text-white ms-2">example@gmail.com</span></p>
            <Row className="g-2 mt-2">
              <Col xs={6} sm={4} md={3} lg={6}>
                <span role="button"> <Image height={45} width={145} src={googlePlay} alt="google-play" /> </span>
              </Col>
              <Col xs={6} sm={4} md={3} lg={6}>
                <span role="button"> <Image height={45} width={145} src={playStore} alt="app-store" /> </span>
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <div className="py-3">
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body-secondary"> Copyrights ©2024 Eduport. Build by <Link href={developedByLink} className="text-body-secondary text-primary-hover">{developedBy}</Link>. </div>
                  ...
                  <li className="list-inline-item text-primary-hover">
                    <Dropdown className="dropup mt-0 text-center text-sm-end">
                      <DropdownToggle as='a' className="nav-link arrow-none" role="button" id="languageSwitcher" data-bs-toggle="dropdown" aria-expanded="false">
                        <FaGlobe className="me-2" />Language <FaChevronUp size={12} />
                      </DropdownToggle>
                      <DropdownMenu as='ul' className="min-w-auto" aria-labelledby="languageSwitcher">
                        <li><DropdownItem className="me-4 text-body" href="#"><Image alt="uk" height={12} width={18} className="fa-fw me-2" src={ukFlag} />English</DropdownItem></li>
                        <li><DropdownItem className="me-4 text-body" href="#"><Image alt="gr" height={12} width={18} className="fa-fw me-2" src={grFlag} />German </DropdownItem></li>
                        <li><DropdownItem className="me-4 text-body" href="#"><Image alt="sp" height={12} width={18} className="fa-fw me-2" src={spFlag} />French</DropdownItem></li>
                      </DropdownMenu>
                    </Dropdown>
                  </li>
                  <li className="list-inline-item text-primary-hover"><a className="nav-link" href="#">Terms of use</a></li>
                  <li className="list-inline-item text-primary-hover"><a className="nav-link pe-0" href="#">Privacy policy</a></li>
                </ul>
              </div>
            </div>
          </Container>
