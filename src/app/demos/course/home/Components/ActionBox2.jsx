                ...
                <Col xs={11} className="position-relative">
                  <Row className="align-items-center">
                    <Col lg={7}>
                      ...
                      <p className="text-white small">Boost up your knowledge, grow your skill with the most reliable online courses and certifications</p>
                      <ul className="list-inline mb-0 justify-content-center justify-content-lg-start">
                        <li className="list-inline-item text-white me-2 icons-center"> <BsCheckCircleFill className="text-success me-2" />Free registration</li>
                        <li className="list-inline-item text-white me-2 icons-center"> <BsCheckCircleFill className="text-success me-2" />Powerful features</li>
                      </ul>
                    </Col>
                    <Col lg={5} className="text-lg-end mt-3 mt-lg-0">
                      <Button variant="warning" className="mb-0">Sign Up for Free</Button>
                    </Col>
                  </Row>
                </Col>
              </Row>
