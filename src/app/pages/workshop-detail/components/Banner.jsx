      ...
      <Container>
        <Row className="g-4 g-md-5">
          <Col lg={8}>
            ...
            <div className="d-sm-flex justify-content-between align-items-center mb-2">
              ...
              <div className="mt-2 mt-sm-0">
                <p className="text-danger mb-0"><BsClockHistory className="me-2" />Class Start in: 22 Days 15:01:30</p>
                <a href="#" className="btn btn-link mb-0 p-0 text-primary-hover text-decoration-underline text-reset">Notify me</a>
              </div>
            </div>
            <p className="mb-0">We understand that theory is important to build a solid foundation, we understand that theory alone isn&apos;t going to get the job done so that&apos;s why this course is packed with practical hands-on examples that you can follow step by step.</p>
          </Col>
          <Col lg={4}>
            <Card className="card-body bg-light p-5 text-center">
              <h5 className="fw-normal">One-Time Payment</h5>
              <h2>$557</h2>
              <Button variant='blue' className="mb-2">Enroll now</Button>
          ...
          <Col md={12} className="text-center mx-auto">
            <Card className="card-body shadow p-2 h-200px h-sm-400px position-relative overflow-hidden" style={{
            backgroundImage: `url(${about28Img.src})`,
