    ...
    <CardBody className="px-3">
      <div className="d-flex justify-content-between align-items-center">
        <div>
          ...
          <p className="mb-0 text-danger"><FaStopwatch className="me-2" />5 days left at this price</p>
        </div>
        <Dropdown>
      ...
      <div className="mt-3 d-sm-flex justify-content-sm-between">
        <Button variant="outline-primary" className="mb-0">Free trial</Button>&nbsp;
        <Button variant="success" className="mb-0">Buy course</Button>
      </div>
    </CardBody>
  </Card>;
};
      ...
      <Col xs={8}>
        ...
        <ul className="list-group list-group-borderless mt-1 d-flex justify-content-between">
          <li className="list-group-item px-0 d-flex justify-content-between">
            ...
            <span className="h6 fw-light">4.5<FaStar className="text-warning ms-1" /></span>
          </li>
        </ul>
      </Col>
    </Row>
      ...
      <Col xs={8}>
        ...
        <ul className="list-group list-group-borderless mt-1 d-flex justify-content-between">
          <li className="list-group-item px-0 d-flex justify-content-between">
            ...
            <span className="h6 fw-light">4.0<FaStar className="text-warning ms-1" /></span>
          </li>
        </ul>
      </Col>
    </Row>
