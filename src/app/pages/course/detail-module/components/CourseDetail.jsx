            ...
            <Row className="g-4" key={idx}>
              ...
              <Col sm={10} xl={11}>
                ...
                <div className="hstack gap-3 flex-wrap">
                  <Button variant="primary" size="sm" className="mb-0"><BsPlayFill className="me-2" />Play</Button>
                  <a href="#" className="text-success mb-0"><BsPencilSquare className="me-2" />Edit</a>
                  <a href="#" className="text-danger mb-0"><BsTrash className="me-2" />Delete</a>
                </div>
              </Col>
            </Row>
                ...
                <CardHeader className="border-bottom px-4 pt-3 pb-0">
                  <Nav defaultActiveKey="0" className="nav-bottom-line py-0" id="course-pills-tab" role="tablist">
                    <NavItem className="me-2 me-sm-4" role="presentation">
                      <NavLink as='button' eventKey="course" className="mb-2 mb-md-0" type="button" role="tab">Course Materials</NavLink>
                    </NavItem>
                    <NavItem className="me-2 me-sm-4" role="presentation">
                      <NavLink as='button' eventKey="notes" className="mb-2 mb-md-0" type="button" role="tab">Notes</NavLink>
                    </NavItem>
                    <NavItem className="me-2 me-sm-4" role="presentation">
                      <NavLink as='button' eventKey="discussion" className="mb-2 mb-md-0" type="button" role="tab">Discussion</NavLink>
                    </NavItem>
                  </Nav>
                </CardHeader>
