...
const CourseList = () => {
  ...
  return <section className="pb-0 py-sm-5">
      <Container>
            ...
            <Row className="g-3 align-items-center justify-content-md-end me-auto">
              <Col sm={4} xl={6} className="text-md-end d-none d-md-block">
                <ul className="list-inline mb-0">
                  <li className="list-inline-item"><Link href="/pages/course/grid" className="btn btn-outline-light mb-0 me-2"><FaThLarge className="fa-fw" /></Link></li>
                  <li className="list-inline-item"><Link href="/pages/course/list" className="btn btn-outline-light mb-0 me-2"><FaListUl className="fa-fw" /></Link></li>
                </ul>
              </Col>
              ...
              <Col xs={4} className="text-md-end">
                <Button onClick={toggle} variant="primary" className="mb-0 d-xl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSidebar" aria-controls="offcanvasSidebar">
        ...
        <Row>
          <Col xl={9} xxl={8}>
            <Row className="g-4">
              {allCourses?.slice(0, 4).map((course, idx) => <Col xs={12} key={idx}>
          ...
          <Col lg={3} xxl={4}>
            {width >= 1200 ? <>
                ...
                <div className="d-grid p-2 p-xl-0 bg-body text-center">
                  <Button variant="primary" className="btn btn-primary mb-0">Filter Results</Button>
                </div>
                ...
                <OffcanvasHeader className="bg-light" closeButton>
                  <OffcanvasTitle as='h5' id="offcanvasNavbarLabel">Advance Filter</OffcanvasTitle>
                </OffcanvasHeader>
