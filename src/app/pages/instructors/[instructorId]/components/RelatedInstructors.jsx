  ...
  return <Card className="bg-transparent">
      <div className="position-relative">
        ...
        <div className="card-img-overlay d-flex flex-column p-3">
          <div className="w-100 mt-auto text-end">
            <a href="#" className="badge text-bg-info rounded-1"><FaUserGraduate className="me-2" />25</a>
            <a href="#" className="badge text-bg-orange rounded-1"><FaClipboardList className=" me-2" />15</a>
          </div>
        </div>
      </div>
      <CardBody className="text-center">
        ...
        <ul className="list-inline hstack justify-content-center">
          ...
          <li className="list-inline-item me-0 small"><FaStar className="text-warning" /></li>
          <li className="list-inline-item me-0 small"><FaStar className="text-warning" /></li>
          <li className="list-inline-item me-0 small"><FaStar className="text-warning" /></li>
          <li className="list-inline-item me-0 small"><FaStar className="text-warning" /></li>
          <li className="list-inline-item me-0 small"><FaStarHalfAlt className="text-warning" /></li>
        </ul>
      </CardBody>
    </Card>;
};
      ...
      <section>
        <Container>
          ...
          <div className="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover">
            <TinySlider className="tiny-slider-inner" settings={courseSliderSettings} data-autoplay="false" data-arrow="true" data-dots="false" data-items={4} data-items-lg={3} data-items-md={2} data-items-xs={1}>
              {instructorsData.map((item, idx) => <RelatedInstructorsData key={idx} {...item} />)}
            </TinySlider>
          </div>
        </Container>
      </section>
