...
import { FaEnvelope, FaFacebookF, FaGlobe, FaGraduationCap, FaHeadphones, FaInstagram, FaMapMarkerAlt, FaRegStar, FaStar, FaStarHalfAlt, FaTwitter } from "react-icons/fa";
import Counter from "./Counter";
import CoursesList from "./CoursesList";
import RelatedInstructors from "./RelatedInstructors";
import { FaLinkedinIn } from "react-icons/fa6";
const InstructorDetailCard = () => {
  return <Card className="shadow p-2 mb-4 text-center">
      <div className="rounded-3">
        <Image src={instructor7} className="card-img" alt="course image" />
      </div>
      <CardBody className="px-3">
        ...
        <ul className="list-inline mb-0">
          <li className="list-inline-item"> <a className="btn px-2 btn-sm bg-facebook" href="#"><FaFacebookF className="h-13px" /></a> </li>
          <li className="list-inline-item"> <a className="btn px-2 btn-sm bg-instagram-gradient" href="#"><FaInstagram /></a> </li>
          <li className="list-inline-item"> <a className="btn px-2 btn-sm bg-twitter" href="#"><FaTwitter /></a> </li>
          <li className="list-inline-item"> <a className="btn px-2 btn-sm bg-linkedin" href="#"><FaLinkedinIn className="fab fa-fw fa-linkedin-in" /></a> </li>
        </ul>
      </CardBody>
    </Card>;
};
const EducationCard = () => {
  return <Card className="card-body shadow p-4 mb-4">
      ...
      <div className="d-flex align-items-center mb-4">
        <span className="icon-md mb-0 bg-light rounded-3"><FaGraduationCap /></span>
        <div className="ms-3">
...
const InstructorDetails = () => {
  return <section className="pt-5 pb-0">
      <Container>
          ...
          <Col lg={8}>
            ...
            <ul className="list-group list-group-borderless">
              <li className="list-group-item px-0">
                <span className="h6 fw-light"><FaMapMarkerAlt className="text-primary me-1 me-sm-3" />Address:</span>
                <span>2002 Horton Ford Rd, Eidson, TN, 37731</span>
              </li>
              <li className="list-group-item px-0">
                <span className="h6 fw-light"><FaEnvelope className="text-primary me-1 me-sm-3" />Email:</span>
                <span>example@gmail.com</span>
              </li>
              <li className="list-group-item px-0">
                <span className="h6 fw-light"><FaHeadphones className="text-primary me-1 me-sm-3" />Phone number:</span>
                <span>+896-789-546</span>
              </li>
              <li className="list-group-item px-0">
                <span className="h6 fw-light"><FaGlobe className="text-primary me-1 me-sm-3" />Website:</span>
                <span>https://themes.stackbros.com/eduport-next/</span>
              </li>
            </ul>
