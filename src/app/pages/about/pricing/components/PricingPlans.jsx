  ...
  return <Card className="border rounded-3 p-2 p-sm-4 h-100">
      <CardHeader className="p-0">
        <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
          ...
          <div>
            <h4 className="text-success mb-0 plan-price">{currency}{price}</h4>
      ...
      <CardBody className="pt-0">
        <ul className="list-unstyled mt-2 mb-0">
          ...
          return <li className="mb-3 h6 fw-light" key={idx}>{Icon && <Icon className={`text-${feature.variant} me-2`} />}{feature.name}</li>;
        })}
        </ul>
      </CardBody>
      <CardFooter className="text-center d-grid pb-0">
        <Button type="button" variant={isRecommended ? "dark" : "light"} className="mb-0">Get Started</Button>
      </CardFooter>
    </Card>;
};
const PricingPlans = () => {
