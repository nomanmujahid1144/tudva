...
const BlogInfo = ({
  ...
  return <section className="pb-0 pt-4 pb-md-5">
      <Container>
        <Row>
          <Col xs={12}>
            <Row>
              <Col lg={3} className="align-items-center mt-4 mt-lg-5 order-2 order-lg-1">
                <div className="text-lg-center">
                  <div className="position-relative">
                    ...
                    <a href="#" className="h5 stretched-link mt-2 mb-0 d-block">{blog.name}</a>
                  ...
                  <ul className="list-inline list-unstyled">
                    ...
                    <li className="list-inline-item badge text-bg-orange"><FaRegHeart className="text-white me-1" />266</li>
                    <li className="list-inline-item badge text-bg-info"><FaRegEye className="me-1" />2K</li>
                  </ul>
                </div>
              </Col>
              <Col lg={9} className="order-1">
                <span>40D ago</span><span className="mx-2">|</span><div className="badge text-bg-success">{blog.category.name}</div>
            ...
            <Row className="mt-4">
              <Col xl={10} className="mx-auto">
                <Card className="overflow-hidden h-200px h-sm-300px h-lg-400px h-xl-500px rounded-3 text-center" style={{
                backgroundImage: `url(${event10.src})`,
                  ...
                  <div className="card-img-overlay d-flex align-items-center p-2 p-sm-4">
                    <div className="w-100 my-auto">
                      <Row className="justify-content-center">
                        <Col xs={12}>
                          <GlightBox href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lg text-danger btn-round btn-white-shadow stretched-link position-static mb-0" data-glightbox data-gallery="video-tour">
                            <FaPlay />
                          </GlightBox>
                        </Col>
                      </Row>
            ...
            <Row className="mt-4">
              <Col xs={12} className="mt-4 mt-lg-0">
                ...
                <ul className="list-group list-group-borderless mb-3">
                  <li className="list-group-item"><FaCheckCircle className="text-success me-2" />The copy warned the Little blind text</li>
                  <li className="list-group-item d-flex"><FaCheckCircle className="text-success me-2 mt-1" />ThaT where it came from it would have been rewritten a thousand times and everything that was left from origin would be the world</li>
                  <li className="list-group-item"><FaCheckCircle className="text-success me-2" />Return to its own, safe country</li>
                </ul>
            ...
            <Row className="g-4 mt-4">
              <Col sm={6} md={4}>
                <GlightBox href={event7.src} data-gallery="image-popup">
                  <Image src={event7} className="rounded-3" alt="event" />
                </GlightBox>
              </Col>
              <Col sm={6} md={4}>
                <GlightBox href={event8.src} data-gallery="image-popup">
                  <Image src={event8} className="rounded-3" alt="event" />
                </GlightBox>
              </Col>
              <Col sm={6} md={4}>
                <GlightBox href={event6.src} data-gallery="image-popup">
                  <Image src={event6} className="rounded-3" alt="event" />
                </GlightBox>
              </Col>
            </Row>
            <Row>
            ...
            <div className="d-lg-flex justify-content-lg-between mb-4">
              <div className="align-items-center mb-3 mb-lg-0">
                ...
                <ul className="list-inline mb-0 mb-2 mb-sm-0">
                  <li className="list-inline-item"> <Link className="btn px-2 btn-sm bg-facebook" href=""><FaFacebookF className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn px-2 btn-sm bg-instagram-gradient" href=""><FaInstagram className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn px-2 btn-sm bg-twitter" href=""><FaTwitter className="fa-fw" /></Link> </li>
                  <li className="list-inline-item"> <Link className="btn px-2 btn-sm bg-linkedin" href=""><FaLinkedin className="fa-fw" /></Link> </li>
                </ul>
              </div>
              <div className="align-items-center">
                <h6 className="mb-2 me-4 d-inline-block">Popular Tags:</h6>
                <ul className="list-inline mb-0 social-media-btn">
                  <li className="list-inline-item"> <Button variant="outline-light" size="sm" className="mb-lg-0">blog</Button> </li>
                  <li className="list-inline-item"> <Button variant="outline-light" size="sm" className="mb-lg-0">business</Button> </li>
                  <li className="list-inline-item"> <Button variant="outline-light" size="sm" className="mb-lg-0">bootstrap</Button> </li>
                  <li className="list-inline-item"> <Button variant="outline-light" size="sm" className="mb-lg-0">data science</Button> </li>
                  <li className="list-inline-item"> <Button variant="outline-light" size="sm" className="mb-lg-0">deep learning</Button> </li>
                </ul>
              </div>
            </div>
            <hr />
