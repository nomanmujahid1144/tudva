...
const Blogs = () => {
  ...
  return <section className="position-relative pt-0">
      <Container>
        <Row className="g-4 filter-container overflow-hidden" data-isotope="{&quot;layoutMode&quot;: &quot;masonry&quot;}">
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-transparent">
              <div className="overflow-hidden rounded-3">
                <Image src={event2} className="card-img" alt="course image" />
              ...
              <CardBody className="px-3">
                <CardTitle><Link href="">Student Loan Survey: Many Owe $50K-plus</Link></CardTitle>
          ...
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-light p-3">
              <CardBody className="">
                ...
                <CardTitle><Link href="">How to make a college list</Link></CardTitle>
            ...
            <Card className="h-100 bg-transparent">
              <div className="card-img-top rounded-3 overflow-hidden position-relative hover-overlay-top">
                <div className="ratio ratio-16x9">
                  <iframe width={620} height={347} src="https://www.youtube.com/embed/9No-FiEInLA" allow="autoplay; encrypted-media" allowFullScreen />
                </div>
              </div>
              <CardBody className=" px-3">
                <a href="#" className="badge text-bg-purple mb-2">Travel</a>
                <CardTitle><Link href="">Never underestimate the influence of Eduport</Link></CardTitle>
          ...
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-transparent">
              <div className="overflow-hidden rounded-3">
                <Image src={event3} className="card-img-top" alt="course image" />
                <div className="bg-overlay bg-dark opacity-4" />
                <div className="card-img-overlay d-flex align-items-start p-3">
                  <a href="#" className="badge text-bg-warning">Lifestyle</a>
                </div>
              </div>
              <CardBody className=" px-3">
                <CardTitle><Link href="">Covid-19 and the college experienced</Link></CardTitle>
          ...
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-dark p-3" style={{
            background: `url(${pattern5.src}) no-repeat center center`,
            backgroundSize: 'cover'
          }}>
              <CardBody className="">
                <a href="#" className="badge text-bg-warning mb-2">Lifestyle</a>
                <CardTitle className="text-primary-hover mb-1"><a href="#" className="text-white">Student Success</a></CardTitle>
                ...
                <ul className="list-inline mb-0 mt-3">
                  ...
                  <li className="list-inline-item text-primary-hover me-3 mb-1 mb-xl-0"><a href="#" className="text-white"><BsHeart className="me-1" />10</a></li>
                  <li className="list-inline-item text-primary-hover me-3 mb-1 mb-xl-0"><a href="#" className="text-white"><FaComment className="me-1" />5</a></li>
                  <li className="list-inline-item text-primary-hover me-3 mb-1 mb-xl-0"><a href="#" className="text-white"><FaTag className="me-1" />Business</a></li>
                </ul>
              </CardBody>
            </Card>
          </Col>
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-info p-3" style={{
            background: `url(${pattern3.src}) no-repeat center center`,
            backgroundSize: 'cover'
          }}>
              <CardBody className="">
                <CardTitle className="text-primary-hover mb-1"><a href="#" className="text-white">Choose your direction</a></CardTitle>
                <p className="text-white mb-0">https://themes.stackbros.com/eduport-next</p>
              </CardBody>
            </Card>
          </Col>
          <Col sm={6} lg={4} className="grid-item">
            <Card className="h-100 bg-transparent">
              ...
              <CardBody className=" px-3">
                <a href="#" className="badge text-bg-purple mb-2">Technology</a>
                <CardTitle><Link href="">10 things you need to know about Eduport</Link></CardTitle>
                <p className="text-truncate-2">Prospective students should start broadly and then narrow their list </p>
                <div className="d-flex justify-content-between">
          ...
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-transparent">
              <div className="overflow-hidden rounded-3">
                <Image src={event4} className="card-img" alt="course image" />
                <div className="bg-overlay bg-dark opacity-4" />
                <div className="card-img-overlay d-flex align-items-start p-3">
              ...
              <CardBody className=" px-3">
                <CardTitle><Link href="">The Olympics are over, now what?</Link></CardTitle>
                <p>Rooms oh fully taken by worse do. Points afraid but may end law. Points afraid but may end law. </p>
                <div className="d-flex justify-content-between">
                  <h6 className="mb-0"><a href="#">Amanda Reed</a></h6>
          ...
          <Col sm={6} lg={4} className="grid-item">
            <Card className="bg-transparent">
              <div className="overflow-hidden rounded-3">
                <Image src={event1} className="card-imgp" alt="course image" />
                <div className="bg-overlay bg-dark opacity-4" />
                <div className="card-img-overlay d-flex align-items-start p-3">
              ...
              <CardBody className=" px-3">
                <CardTitle><Link href="">Campus Support for First-Year Students</Link></CardTitle>
                <p className="text-truncate-2">Prospective students should start broadly and then narrow their list </p>
                <div className="d-flex justify-content-between">
        ...
        <div className="text-center mt-4">
          <Button variant="primary-soft" className="mb-0">Load more<FaSync className="ms-2" /></Button>
        </div>
      </Container>
    </section>;
};
