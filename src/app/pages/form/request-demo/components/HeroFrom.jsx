      ...
      <Container>
        <Row className="g-4 g-md-5 justify-content-between">
          <Col lg={6} className="mb-5 mb-lg-0">
            ...
            <p className="mb-5">Let&apos;s find out the demo. The 1-hour demo will provide Happiness prosperous impression had conviction For every delay in their Extremity now, strangers</p>
            <h4 className="mb-3">What you will get inside the demo?</h4>
            <ul className="list-group list-group-borderless mt-3 mb-sm-5">
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />An overview of the platform and its features</li>
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />Share few success stories with you</li>
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />Actionable learning functionality</li>
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />No communication gap</li>
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />Better addressable of group level issue</li>
              <li className="list-group-item h6 fw-light d-flex"><FaCheckCircle className="fa-fw text-success me-2" />Unlimited access to 5K+ Courses</li>
            </ul>
            ...
            <div className="bg-dark rounded-3 p-4 p-sm-5 position-relative">
              ...
              <form className="row g-3 position-relative" onSubmit={handleSubmit(() => {})}>
                ...
                <Col xs={12} className="bg-dark-input">
                  ...
                  <p className="mb-0 text-white text-opacity-50 small">Field required with <span className="text-danger fw-bold">*</span> are required to complete the demo request</p>
                </Col>
              </form>
            </div>
          </Col>
