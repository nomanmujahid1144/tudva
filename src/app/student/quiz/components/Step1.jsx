...
const Step1 = ({
  ...
  return <form id="step-1" onSubmit={goToNextStep} role="tabpanel" className="content show fade" aria-labelledby="steppertrigger1">
      ...
      <div className="d-flex justify-content-center mt-3">
        <button type="submit" className="btn btn-primary next-btn mb-0">Next question</button>
      </div>
    </form>;
};
