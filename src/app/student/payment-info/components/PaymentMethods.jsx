...
const PaymentMethods = () => {
  return <Card className="bg-transparent border rounded-3 mb-4 z-index-9">
      <CardHeader className="bg-transparent d-sm-flex justify-content-sm-between align-items-center border-bottom">
        ...
        <Button variant='primary-soft' size='sm' className=" mb-0" data-bs-toggle="modal" data-bs-target="#addNewcard">Add new card</Button>
      </CardHeader>
      <CardBody>
        <Accordion className="accordion-circle" id="accordioncircle">
          <AccordionItem eventKey='1' className="mb-3">
            <AccordionHeader as='h6' className="font-base" id="heading-1">
              <div className="bg-white rounded collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
                ...
                <form className="row text-start g-3">
                  <Col xs={12}>
                    ...
                    <div className="position-relative">
                      ...
                      <Image src={visaImg} className="w-40px position-absolute top-50 end-0 translate-middle-y me-2 d-none d-sm-block" alt='visaImg' />
                    </div>
                  </Col>
                  <Col md={6}>
          ...
          <AccordionItem eventKey='2' className="mb-3">
            <AccordionHeader as='h6' className="accordion-header font-base" id="heading-2">
              <div className="collapsed bg-white rounded" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
