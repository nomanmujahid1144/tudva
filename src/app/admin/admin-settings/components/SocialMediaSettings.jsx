  ...
  return <Card className="shadow">
        ...
        <CardBody>
          <form className="row g-4">
            <Col sm={6}>
              <label className="form-label icons-center"><FcGoogle className="me-2" />Enter google client ID</label>
              <input className="form-control" type="text" />
            </Col>
            <Col sm={6}>
              <label className="form-label"><FcGoogle className="me-2" />Enter google API</label>
              <input className="form-control" type="text" />
            </Col>
            <Col sm={6}>
              <label className="form-label"><FaFacebook className="text-facebook me-2" />Enter facebook client ID</label>
              <input className="form-control" type="text" />
            </Col>
            <Col sm={6}>
              <label className="form-label"><FaFacebook className="text-facebook me-2" />Enter facebook API</label>
              <input className="form-control" type="text" />
            </Col>
