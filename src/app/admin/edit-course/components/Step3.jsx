...
const Step3 = ({
  ...
  return <form id="step-3" role="tabpanel" onSubmit={goToNextStep} className="content fade" aria-labelledby="steppertrigger3">
      <h4>Curriculum</h4>
      <hr />
      <Row className="">
        ...
        <Accordion className="accordion-icon accordion-bg-light" id="accordionExample2">
            ...
            <AccordionBody className="mt-3">
              <div className="d-flex justify-content-between align-items-center">
                <div className="position-relative">
                  <Button variant='danger-soft' size='sm' className="btn-round mb-0 stretched-link position-static"><FaPlay /></Button>
                  <span className="ms-2 mb-0 h6 fw-light">Introduction</span>
                </div>
                <div>
                  <Button variant='success-soft' size='sm' className="btn-round me-1 mb-1 mb-md-0"><FaEdit /></Button>
              ...
              <hr />
              <AddTopic />
              <Button variant='danger-soft' size='sm' className="mb-0 mt-1 mt-sm-0 ms-1">Delete this Lecture</Button>
            </AccordionBody>
          </AccordionItem>
          <AccordionItem eventKey='2' className="mb-3">
            <AccordionHeader as={'h6'} className="font-base" id="heading-2">
              <div className="fw-bold rounded d-inline-block collapsed d-block pe-5" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
                Customer Life cycle
              </div>
            </AccordionHeader>
            <AccordionBody className="mt-3">
          ...
          <AccordionItem eventKey='3' className="mb-3">
            <AccordionHeader as={'h6'} className="font-base" id="heading-3">
              <div className="fw-bold collapsed rounded d-block pe-5">
