...
const ReviewsCard = ({
  ...
  return <tr>
      ...
      <td>
        <div className="d-flex align-items-center position-relative">
          <div className="avatar avatar-xs mb-2 mb-md-0">
            <Image src={avatar} className="rounded-circle" alt="avatar" />
          </div>
      ...
      <td>
        <h6 className="table-responsive-title mb-0"><a href="#">{courseName}</a></h6>
      </td>
      <td>
      ...
      <td>
        ...
        <Button variant='info-soft' size='sm' className=" btn mb-0" data-bs-toggle="modal" data-bs-target="#viewReview">View</Button>
      </td>
    </tr>;
};
const Reviews = () => {
      ...
      <Card className="card-body bg-transparent pb-0 border mb-4">
        <div className="table-responsive border-0">
          <Table className="table-dark-gray align-middle p-4 mb-0 table-hover">
            ...
            <tbody>
              {studentReviewData.map((item, idx) => <ReviewsCard key={idx} {...item} />)}
            </tbody>
          </Table>
        </div>
